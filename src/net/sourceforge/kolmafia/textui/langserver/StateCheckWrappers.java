...
abstract class StateCheckWrappers
{
	...
	static class AshTextDocumentService
		extends net.sourceforge.kolmafia.textui.langserver.textdocumentservice.AshTextDocumentService
	{
		AshTextDocumentService( final net.sourceforge.kolmafia.textui.langserver.AshLanguageServer parent )
		{
			super( parent );
		}
