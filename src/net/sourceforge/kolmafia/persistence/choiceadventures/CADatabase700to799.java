...
class CADatabase700to799 extends ChoiceAdventureDatabase
{
	final void add700to799()
	{
		new ChoiceAdventure( 700, "Delirium in the Cafeterium", null )
		{
			...
			void visitChoice( GenericRequest request )
			{
				...
				getOption( 1 ).text( hasJockEffect ?
					"Gain stats" :
					"Lose HP" );
				getOption( 2 ).text( hasNerdEffect ?
					"Gain stats" :
					"Lose HP" );
				getOption( 3 ).text( hasGreaserEffect ?
					"Gain stats" :
					"Lose HP" );
			}
		...
		new ChoiceAdventure( 711, "They've Got Everything You Want", null )
		{
			void setup()
			{
				new Option( 1 )
					.leadsTo( 712 )
					.attachEffect( "More Like a Suckrament" );
			}
		};
		...
		new ChoiceAdventure( 715, "Life in the Stillness", null )
		{
			void setup()
			{
				new Option( 1 )
					.leadsTo( 716 )
					.attachEffect( "A Hole in the World" );
			}
		};
		...
		new ChoiceAdventure( 721, "The Cabin in the Dreadsylvanian Woods", "Dreadsylvanian Woods" )
		{
			void setup()
			{
				...
				// The Kitchen
				new Option( 1 )
					.leadsTo( 722, true, ( Option o ) -> o.index != 6 );
				// The Cellar
				new Option( 2 )
					.leadsTo( 723, false, ( Option o ) -> o.index != 6 );
				// The Attic (locked)
			...
			String getDecision( String responseText, String decision, int stepCount )
			{
				return CADatabase700to799.ghostPencilDecisionRedirect( responseText, decision, "ghostPencil1" );
			}
		...
		new ChoiceAdventure( 722, "The Kitchen in the Woods", "Dreadsylvanian Woods" )
		{
			void setup()
			{
				new Option( 1, "dread tarragon" )
					.turnCost( 1 )
					.attachItem( ItemPool.DREAD_TARRAGON, 1, AUTO );
				new Option( 2, "old dry bone -> bone flour" )
					.turnCost( 1 )
					.attachItem( ItemPool.OLD_DRY_BONE, -1, MANUAL, new DisplayAll( "dry bone", NEED, INV_ONLY_AT_LEAST, 1 ) )
					.attachItem( ItemPool.BONE_FLOUR, 1, AUTO );
				new Option( 3, "-stench" )
					.turnCost( 1 );
				new Option( 6, "Return to The Cabin" )
					.leadsTo( 721, true );
			}
		...
		new ChoiceAdventure( 723, "What Lies Beneath (the Cabin)", "Dreadsylvanian Woods" )
		{
			void setup()
			{
				new Option( 1, "5-7 Freddies" )
					.turnCost( 1 )
					.attachItem( ItemPool.KRUEGERAND, 5, AUTO );
				new Option( 2, "100 adv of Bored Stiff" )
					.turnCost( 1 )
					.attachEffect( "Bored Stiff" );
				new Option( 3, "replica key -> Dreadsylvanian auditor's badge" )
					.turnCost( 1 )
					.attachItem( ItemPool.REPLICA_KEY, -1, MANUAL, new DisplayAll( "replica key", NEED, AT_LEAST, 1 ) )
					.attachItem( ItemPool.AUDITORS_BADGE, 1, AUTO );
				new Option( 4, "wax banana -> complicated lock impression" )
					.turnCost( 1 )
					.attachItem( ItemPool.WAX_BANANA, -1, MANUAL, new DisplayAll( "banana", NEED, AT_LEAST, 1 ) )
		...
		new ChoiceAdventure( 724, "Where it's Attic", "Dreadsylvanian Woods" )
		{
			void setup()
			{
				new Option( 1 )
					.turnCost( 1 );
				new Option( 2, "fewer werewolves" )
					.turnCost( 1 );
				new Option( 3, "fewer vampires" )
					.turnCost( 1 );
				new Option( 4, "moxie substats" )
					.turnCost( 1 );
				new Option( 6, "Return to The Cabin" )
					.leadsTo( 721, true );
			}
			...
			void visitChoice( GenericRequest request )
			{
				...
				{
					option.text( "-spooky + intricate music box parts" )
				...
				else
				{
					option.text( "-spooky" +
						( request == null ? "" :
						  " (don't -- have an Accordion Thief do this)" ) );
				}
			}
		};
		...
		new ChoiceAdventure( 725, "The Tallest Tree in the Forest", "Dreadsylvanian Woods" )
		{
			void setup()
			{
				...
				new Option( 1 )
					.leadsTo( 726, false, ( Option o ) -> o.index != 6 );
				// Fire Tower (locked)
				...
				// Base of tree
				new Option( 3 )
					.leadsTo( 728, true, ( Option o ) -> o.index != 6 );
				new Option( 5, "learn shortcut", true )
					.turnCost( 1 )
					.attachItem( ItemPool.GHOST_PENCIL, -1, MANUAL, new DisplayAll( NEED, AT_LEAST, 1 ) );
				new Option( 6, "skip adventure", true )
			...
			String getDecision( String responseText, String decision, int stepCount )
			{
				return CADatabase700to799.ghostPencilDecisionRedirect( responseText, decision, "ghostPencil2" );
			}
		...
		new ChoiceAdventure( 726, "Top of the Tree, Ma!", "Dreadsylvanian Woods" )
		{
			void setup()
			{
				...
				new Option( 2, "-sleaze" )
					.turnCost( 1 );
				new Option( 3, "moon-amber" )
					.turnCost( 1 )
					.attachItem( ItemPool.MOON_AMBER, 1, AUTO );
				new Option( 6, "Return to The Tallest Tree" )
					.leadsTo( 725, true );
			}
		...
		new ChoiceAdventure( 727, "All Along the Watchtower", "Dreadsylvanian Woods" )
		{
			void setup()
			{
				new Option( 1, "fewer ghosts" )
					.turnCost( 1 );
				new Option( 2, "7-11 Freddies" )
					.turnCost( 1 )
					.attachItem( ItemPool.KRUEGERAND, 7, AUTO );
				new Option( 3, "muscle substats" )
					.turnCost( 1 );
				new Option( 6, "Return to The Tallest Tree" )
					.leadsTo( 725, true );
			}
		...
		new ChoiceAdventure( 728, "Treebasing", "Dreadsylvanian Woods" )
		{
			void setup()
			{
				new Option( 1, "blood kiwi (from above)" )
					.leadsTo( 761 );
		...
		new ChoiceAdventure( 729, "Below the Roots", "Dreadsylvanian Woods" )
		{
			void setup()
			{
				...
				// Hot
				new Option( 1 )
					.leadsTo( 730, false, ( Option o ) -> o.index != 6 );
				// Cold
				new Option( 2 )
					.leadsTo( 731, false, ( Option o ) -> o.index != 6 );
				// Smelly
				new Option( 3 )
					.leadsTo( 732, false, ( Option o ) -> o.index != 6 );
				new Option( 5, "learn shortcut", true )
					.turnCost( 1 )
					.attachItem( ItemPool.GHOST_PENCIL, -1, MANUAL, new DisplayAll( NEED, AT_LEAST, 1 ) );
				new Option( 6, "skip adventure", true )
			...
			String getDecision( String responseText, String decision, int stepCount )
			{
				return CADatabase700to799.ghostPencilDecisionRedirect( responseText, decision, "ghostPencil3" );
			}
		};
		...
		new ChoiceAdventure( 730, "Hot Coals", "Dreadsylvanian Woods" )
		{
			void setup()
			{
				...
				new Option( 3, "old ball and chain -> cool iron ingot" )
					.turnCost( 1 )
					.attachItem( ItemPool.OLD_BALL_AND_CHAIN, -1, MANUAL, new DisplayAll( "ball and chain", NEED, INV_ONLY_AT_LEAST, 1 ) )
					.attachItem( ItemPool.COOL_IRON_INGOT, 1, AUTO );
				new Option( 6, "Return to The Burrows" )
					.leadsTo( 729, true );
			}
		...
		new ChoiceAdventure( 731, "The Heart of the Matter", "Dreadsylvanian Woods" )
		{
			void setup()
			{
				new Option( 1, "-cold" )
					.turnCost( 1 );
				new Option( 2, "mysticality substats" )
					.turnCost( 1 );
				new Option( 3, "100 adv of Nature's Bounty" )
					.turnCost( 1 )
					.attachEffect( "Nature's Bounty" );
				new Option( 6, "Return to The Burrows" )
					.leadsTo( 729, true );
			}
		};
		...
		new ChoiceAdventure( 732, "Once Midden, Twice Shy", "Dreadsylvanian Woods" )
		{
			void setup()
			{
				new Option( 1, "fewer bugbears" )
					.turnCost( 1 );
				new Option( 2, "5-6 Freddies" )
					.turnCost( 1 )
					.attachItem( ItemPool.KRUEGERAND, 5, AUTO );
				new Option( 6, "Return to The Burrows" )
					.leadsTo( 729, true );
		...
		new ChoiceAdventure( 733, "Dreadsylvanian Village Square", "Dreadsylvanian Village" )
		{
			void setup()
			{
				...
				// Blacksmith
				new Option( 2 )
					.leadsTo( 735, true, ( Option o ) -> o.index != 6 );
				// Gallows
				new Option( 3 )
					.leadsTo( 736, true, ( Option o ) -> o.index != 6 && o.index != 3 );
				new Option( 5, "learn shortcut", true )
					.turnCost( 1 )
					.attachItem( ItemPool.GHOST_PENCIL, -1, MANUAL, new DisplayAll( NEED, AT_LEAST, 1 ) );
				new Option( 6, "skip adventure", true )
			...
			String getDecision( String responseText, String decision, int stepCount )
			{
				return CADatabase700to799.ghostPencilDecisionRedirect( responseText, decision, "ghostPencil4" );
			}
		...
		new ChoiceAdventure( 734, "Fright School", "Dreadsylvanian Village" )
		{
			void setup()
			{
				new Option( 1, "fewer ghosts" )
					.turnCost( 1 );
				new Option( 2, "ghost pencil" )
					.turnCost( 1 )
					.attachItem( ItemPool.GHOST_PENCIL, 1, AUTO );
				new Option( 3, "mysticality substats" )
					.turnCost( 1 );
				new Option( 6, "Return to The Village Square" )
					.leadsTo( 733, true );
			}
		...
		new ChoiceAdventure( 736, "Good Noose, Everyone!", "Dreadsylvanian Village" )
		{
			void setup()
			{
				new Option( 1, "-spooky" )
					.turnCost( 1 );
				new Option( 2 )
					.leadsTo( 765, true, ( Option o ) -> o.index == 1 );
				new Option( 3, "refresh the trap door" )
					.entersQueue( false );
			...
			void postChoice1( GenericRequest request, int decision )
			{
				if ( decision == 4 )
				{
					// You pull the lever, sending your clanmate <Clanmate> hurtling through the floor of the gallows platform. Whee!
		...
		new ChoiceAdventure( 737, "The Even More Dreadful Part of Town", "Dreadsylvanian Village" )
		{
			void setup()
			{
				...
				// Sewers
				new Option( 1 )
					.leadsTo( 738, false, ( Option o ) -> o.index != 6 );
				// Tenement
				new Option( 2 )
					.leadsTo( 740, false, ( Option o ) -> o.index != 6 );
				// Ticking Shack (moxie only)
				new Option( 3 )
					.leadsTo( 739, false, ( Option o ) -> o.index != 6 );
				new Option( 5, "learn shortcut", true )
					.turnCost( 1 )
					.attachItem( ItemPool.GHOST_PENCIL, -1, MANUAL, new DisplayAll( NEED, AT_LEAST, 1 ) );
				new Option( 6, "skip adventure", true )
			...
			String getDecision( String responseText, String decision, int stepCount )
			{
				return CADatabase700to799.ghostPencilDecisionRedirect( responseText, decision, "ghostPencil5" );
			}
		};
		...
		new ChoiceAdventure( 738, "A Dreadful Smell", "Dreadsylvanian Village" )
		{
			void setup()
			{
				new Option( 1, "-stench" )
					.turnCost( 1 );
				new Option( 2, "100 adv of Sewer-Drenched" )
					.turnCost( 1 )
					.attachEffect( "Sewer-Drenched" );
				new Option( 6, "Return to Skid Row" )
					.leadsTo( 737, true );
			}
		};
		...
		new ChoiceAdventure( 739, "The Tinker's. Damn.", "Dreadsylvanian Village" )
		{
			void setup()
			{
				new Option( 1, "5-6 Freddies" )
					.turnCost( 1 )
					.attachItem( ItemPool.KRUEGERAND, 5, AUTO );
				new Option( 2, "lock impression + music box parts -> replica key" )
					.turnCost( 1 )
					.attachItem( ItemPool.WAX_LOCK_IMPRESSION, -1, MANUAL, new DisplayAll( "impression", NEED, AT_LEAST, 1 ) )
					.attachItem( ItemPool.INTRICATE_MUSIC_BOX_PARTS, -1, MANUAL, new DisplayAll( "box parts", NEED, AT_LEAST, 1 ) )
					.attachItem( ItemPool.REPLICA_KEY, 1, AUTO );
				new Option( 3, "moon-amber -> polished moon-amber" )
					.turnCost( 1 )
					.attachItem( ItemPool.MOON_AMBER, -1, MANUAL, new DisplayAll( "^moon-amber", NEED, AT_LEAST, 1 ) )
					.attachItem( "polished moon-amber", 1, AUTO );
				new Option( 4, "3 music box parts + clockwork key -> mechanical songbird" )
					.turnCost( 1 )
					.attachItem( ItemPool.INTRICATE_MUSIC_BOX_PARTS, -3, MANUAL, new DisplayAll( "box parts", NEED, AT_LEAST, 3 ) )
					.attachItem( ItemPool.DREADSYLVANIAN_CLOCKWORK_KEY, -1, MANUAL, new DisplayAll( "clockwork key", NEED, AT_LEAST, 1 ) )
		...
		new ChoiceAdventure( 741, "The Old Duke's Estate", "Dreadsylvanian Village" )
		{
			void setup()
			{
				...
				// Cemetery
				new Option( 1 )
					.leadsTo( 742, false, ( Option o ) -> o.index != 6 );
				// Servants' Quarters
				new Option( 2 )
					.leadsTo( 743, true, ( Option o ) -> o.index != 6 );
				// Master Suite (locked)
				new Option( 3, "possibly locked" )
			...
			String getDecision( String responseText, String decision, int stepCount )
			{
				return CADatabase700to799.ghostPencilDecisionRedirect( responseText, decision, "ghostPencil6" );
			}
		...
		new ChoiceAdventure( 742, "The Plot Thickens", "Dreadsylvanian Village" )
		{
			void setup()
			{
				...
				new Option( 6, "Return to The Old Duke's Estate" )
					.leadsTo( 741, true );
			}
		...
		new ChoiceAdventure( 743, "No Quarter", "Dreadsylvanian Village" )
		{
			void setup()
			{
				new Option( 1, "-hot" )
					.turnCost( 1 );
				new Option( 2, "dread tarragon + dreadful roast + bone flour + stinking agaricus -> Dreadsylvanian shepherd's pie" )
					.turnCost( 1 )
					.attachItem( ItemPool.DREAD_TARRAGON, -1, MANUAL, new DisplayAll( "dread tarragon", NEED, AT_LEAST, 1 ) )
					.attachItem( ItemPool.DREADFUL_ROAST, -1, MANUAL, new DisplayAll( "dreadful roast", NEED, AT_LEAST, 1 ) )
					.attachItem( ItemPool.BONE_FLOUR, -1, MANUAL, new DisplayAll( "bone flour", NEED, AT_LEAST, 1 ) )
					.attachItem( ItemPool.STINKING_AGARICUS, -1, MANUAL, new DisplayAll( "stinking agaricus", NEED, AT_LEAST, 1 ) )
					.attachItem( ItemPool.SHEPHERDS_PIE, 1, AUTO );
				new Option( 3, "moxie substats" )
					.turnCost( 1 );
				new Option( 6, "Return to The Old Duke's Estate" )
					.leadsTo( 741, true );
			}
		...
		new ChoiceAdventure( 744, "The Master Suite -- Sweet!", "Dreadsylvanian Village" )
		{
			void setup()
			{
				new Option( 1, "fewer werewolves" )
					.turnCost( 1 );
				new Option( 2, "eau de mort" )
					.turnCost( 1 )
					.attachItem( ItemPool.EAU_DE_MORT, 1, AUTO );
				new Option( 3, "ghost threads -> ghost shawl" )
					.turnCost( 1 )
					.attachItem( ItemPool.GHOST_THREAD, -10, MANUAL, new DisplayAll( "threads", NEED, AT_LEAST, 10 ) )
		...
		new ChoiceAdventure( 745, "This Hall is Really Great", "Dreadsylvanian Castle" )
		{
			void setup()
			{
				...
				// Kitchen
				new Option( 2 )
					.leadsTo( 747, false, ( Option o ) -> o.index != 6 );
				// Dining Room
				new Option( 3 )
					.leadsTo( 748, true, ( Option o ) -> o.index != 6 );
				new Option( 5, "learn shortcut", true )
					.turnCost( 1 )
					.attachItem( ItemPool.GHOST_PENCIL, -1, MANUAL, new DisplayAll( NEED, AT_LEAST, 1 ) );
				new Option( 6, "skip adventure", true )
			...
			String getDecision( String responseText, String decision, int stepCount )
			{
				return CADatabase700to799.ghostPencilDecisionRedirect( responseText, decision, "ghostPencil7" );
			}
		...
		new ChoiceAdventure( 746, "The Belle of the Ballroom", "Dreadsylvanian Castle" )
		{
			...
			void setup()
			{
				new Option( 1, "fewer vampires" )
					.turnCost( 1 );
				new Option( 2, "muddy skirt + seed pod -> weedy skirt. Also, moxie substats" )
					.turnCost( 1 )
					// we make them manual in postChoice1
					.attachItem( MUDDY_SKIRT, AUTO, new DisplayAll( "muddy skirt", NEED, EQUIPPED_AT_LEAST, 1 ) )
				...
				new Option( 6, "Return to The Great Hall" )
					.leadsTo( 745, true );
			}
		...
		new ChoiceAdventure( 747, "Cold Storage", "Dreadsylvanian Castle" )
		{
			void setup()
			{
				new Option( 1, "-cold" )
					.turnCost( 1 );
				new Option( 2, "100 adv of Staying Frosty" )
					.turnCost( 1 )
					.attachEffect( "Staying Frosty" );
				new Option( 6, "Return to The Great Hall" )
					.leadsTo( 745, true );
			}
		};
		...
		new ChoiceAdventure( 748, "Dining In (the Castle)", "Dreadsylvanian Castle" )
		{
			void setup()
			{
				new Option( 1, "dreadful roast" )
					.turnCost( 1 )
					.attachItem( ItemPool.DREADFUL_ROAST, 1, AUTO );
				new Option( 2, "-stench" )
					.turnCost( 1 );
				new Option( 3, "wax banana" )
					.turnCost( 1 )
					.attachItem( ItemPool.WAX_BANANA, 1, AUTO );
				new Option( 6, "Return to The Great Hall" )
					.leadsTo( 745, true );
			}
		...
		new ChoiceAdventure( 749, "Tower Most Tall", "Dreadsylvanian Castle" )
		{
			void setup()
			{
				...
				new Option( 2 )
					.leadsTo( 751, true, ( Option o ) -> o.index != 6 );
				// Bedroom
				new Option( 3 )
					.leadsTo( 752, false, ( Option o ) -> o.index != 6 );
				new Option( 5, "learn shortcut", true )
					.turnCost( 1 )
					.attachItem( ItemPool.GHOST_PENCIL, -1, MANUAL, new DisplayAll( NEED, AT_LEAST, 1 ) );
				new Option( 6, "skip adventure", true )
			...
			String getDecision( String responseText, String decision, int stepCount )
			{
				return CADatabase700to799.ghostPencilDecisionRedirect( responseText, decision, "ghostPencil8" );
			}
		...
		new ChoiceAdventure( 750, "Working in the Lab, Late One Night", "Dreadsylvanian Castle" )
		{
			void setup()
			{
				new Option( 1, "fewer bugbears" )
					.turnCost( 1 );
				new Option( 2, "fewer zombies" )
					.turnCost( 1 );
				new Option( 3, "visit The Machine" )
					.leadsTo( 764 )
					.attachItem( ItemPool.SKULL_CAPACITOR );
				new Option( 4, "blood kiwi + eau de mort -> bloody kiwitini" )
					.turnCost( 1 )
					.attachItem( ItemPool.BLOOD_KIWI, -1, MANUAL, new DisplayAll( "blood kiwi", NEED, AT_LEAST, 1 ) )
					.attachItem( ItemPool.EAU_DE_MORT, -1, MANUAL, new DisplayAll( "de mort", NEED, AT_LEAST, 1 ) )
					.attachItem( ItemPool.BLOODY_KIWITINI, 1, AUTO );
				new Option( 6, "Return to The Tower" )
					.leadsTo( 749, true );
			}
		...
		new ChoiceAdventure( 751, "Among the Quaint and Curious Tomes", "Dreadsylvanian Castle" )
		{
			...
			void postChoice1( GenericRequest request, int decision )
			{
				if ( decision == 3 && request.responseText.contains( "already learned everything from that book" ) )
				{
					this.choiceFailed().entersQueue( false );
				}
			}
		...
		new ChoiceAdventure( 753, "The Dreadsylvanian Dungeon", "Dreadsylvanian Castle" )
		{
			void setup()
			{
				...
				// Prison
				new Option( 1 )
					.leadsTo( 754, false, ( Option o ) -> o.index != 6 );
				// Boiler Room
				new Option( 2 )
					.leadsTo( 755, false, ( Option o ) -> o.index != 6 );
				// Guard room
				new Option( 3 )
					.leadsTo( 756, false, ( Option o ) -> o.index != 6 );
				new Option( 5, "learn shortcut", true )
					.turnCost( 1 )
					.attachItem( ItemPool.GHOST_PENCIL, -1, MANUAL, new DisplayAll( NEED, AT_LEAST, 1 ) );
				new Option( 6, "skip adventure", true )
			...
			String getDecision( String responseText, String decision, int stepCount )
			{
				return CADatabase700to799.ghostPencilDecisionRedirect( responseText, decision, "ghostPencil9" );
			}
		};
		...
		new ChoiceAdventure( 754, "Live from Dungeon Prison", "Dreadsylvanian Castle" )
		{
			void setup()
			{
				new Option( 1, "-spooky" )
					.turnCost( 1 );
				new Option( 2, "muscle substats" )
					.turnCost( 1 );
				new Option( 3, "+MP" )
					.turnCost( 1 );
				new Option( 6, "Return to The Dungeons" )
					.leadsTo( 753, true );
			}
		};
		...
		new ChoiceAdventure( 756, "Among the Fungus", "Dreadsylvanian Castle" )
		{
			void setup()
			{
				...
				new Option( 2, "100 adv of Spore-wreathed" )
					.turnCost( 1 )
					.attachEffect( "Spore-wreathed" );
				new Option( 6, "Return to The Dungeons" )
					.leadsTo( 753, true );
			}
		...
		new ChoiceAdventure( 758, "End of the Path", "Dreadsylvanian Woods" )
		{
			...
			void setup()
			{
				...
				new Option( 1 )
					.attachItem( ItemPool.MOON_AMBER_NECKLACE, new DisplayAll( "necklace", WANT, EQUIPPED_AT_LEAST, 1 ) )
			...
			void visitChoice( GenericRequest request )
			{
				...
				StringBuilder buffer = new StringBuilder( "GWotA (moon-amber necklace for hard mode) / Falls-From-Sky (First Blood Kiwi (" );
		...
		new ChoiceAdventure( 759, "You're About to Fight City Hall", "Dreadsylvanian Village" )
		{
			void setup()
			{
				...
				new Option( 1, "Mayor Ghost (auditor's badge for hard mode) / ZHOA (weedy skirt for hard mode)" )
					.attachItem( ItemPool.AUDITORS_BADGE, new DisplayAll( "auditor's badge", WANT, EQUIPPED_AT_LEAST, 1 ) )
					.attachItem( ItemPool.WEEDY_SKIRT, new DisplayAll( "weedy skirt", WANT, EQUIPPED_AT_LEAST, 1 ) );
				new Option( 2, "Run away" );
			}
		};
		...
		new ChoiceAdventure( 760, "Holding Court", "Dreadsylvanian Castle" )
		{
			...
			void visitChoice( GenericRequest request )
			{
				...
				StringBuilder buffer = new StringBuilder( "Drunkula (ghost shawl for hard mode) / Unkillable skeleton (Shepherd's Breath (" );
		...
		new ChoiceAdventure( 761, "Staring Upwards...", "Dreadsylvanian Woods" )
		{
			void setup()
			{
				new Option( 1, "if a clanmate stomps at the top of the tree, get a blood kiwi. Otherwise refreshes" )
					.turnCost( 1 )
		...
		new ChoiceAdventure( 762, "Try New Extra-Strength Anvil", "Dreadsylvanian Village" )
		{
			void setup()
			{
				new Option( 1, "cool iron ingot + warm fur -> cooling iron helmet" )
					.turnCost( 1 )
					.attachItem( ItemPool.COOL_IRON_INGOT, -1, MANUAL, new DisplayAll( "ingot", NEED, AT_LEAST, 1 ) )
					.attachItem( ItemPool.WARM_FUR, -1, MANUAL, new DisplayAll( "warm fur", NEED, AT_LEAST, 1 ) )
		...
		new ChoiceAdventure( 765, "Hello Gallows", "Dreadsylvanian Village" )
		{
			...
			final AdventureResult CURSED_RING_FINGER_RING = new AdventureResult( "cursed ring finger ring", 1, false );
			final AdventureResult DREADSYLVANIAN_CLOCKWORK_KEY = ItemPool.get( ItemPool.DREADSYLVANIAN_CLOCKWORK_KEY, 1 );
		...
		new ChoiceAdventure( 768, "The Littlest Identity Crisis", null )
		{
			...
			final AdventureResult SONG_S = new AdventureResult( "Cafeter&iacute;a Brujer&iacute;a", 1, true );
			...
			void setup()
			{
				new Option( 1, "1+: physical dmg<br>5+: volleyball(+stats)<br>10+: <font color=\"blue\">cold damage</font>+stun<br>15+: removes debuffs" );
				new Option( 2, "1+: volleyball(+stats)<br>5+: starfish(siphons enemy HP into MP)<br>10+: physical dmg + delevel<br>15+: <font color=\"grey\">spooky damage</font>" );
				new Option( 3, "1+: potato(blocks)<br>5+: regen HP<br>10+: leprechaun(+meat)<br>15+: prismatic dmg" );
				new Option( 4 );
				new Option( 5, "1+: delevels<br>5+: fairy(+items)<br>10+: mosquito(siphon enemy HP)<br>15+: physical dmg + delevel" );
				new Option( 6 );
			}
			...
			void visitChoice( GenericRequest request )
			{
				AdventureResult sauce = null;
				AdventureResult song = null;

				switch ( KoLCharacter.getClassType() )
				{
				case KoLCharacter.SEAL_CLUBBER:
					sauce = SAUCE_SC;
					song = SONG_SC;
					break;
				case KoLCharacter.TURTLE_TAMER:
					sauce = SAUCE_TT;
					song = SONG_TT;
					break;
				case KoLCharacter.PASTAMANCER:
					sauce = SAUCE_PM;
					song = SONG_PM;
					break;
				case KoLCharacter.SAUCEROR:
					sauce = SAUCE_S;
					song = SONG_S;
					break;
				case KoLCharacter.DISCO_BANDIT:
					sauce = SAUCE_DB;
					song = SONG_DB;
					break;
				case KoLCharacter.ACCORDION_THIEF:
					sauce = SAUCE_AT;
					song = SONG_AT;
					break;
				}
				...
				sauceOption.text( "1+: leprechaun(+meat)<br>" +
		...
		new ChoiceAdventure( 772, "Saved by the Bell", null )
		{
			...
			void setup()
			{
				...
				new Option( 1 )
					.attachEffect( "School Spirited" );
				new Option( 2, "50 adv of Poetically Licensed" )
					.attachEffect( "Poetically Licensed" );
				new Option( 3, "Get Yearbook Camera" )
					.attachItem( ItemPool.YEARBOOK_CAMERA, new ImageOnly() );
				new Option( 4, "50 adv of Cut But Not Dried" )
					.attachEffect( "Cut But Not Dried" );
				new Option( 5, "50 turns of Isskay Like An Ashtray" )
					.attachEffect( "Isskay like an Ashtray" );
		...
		new ChoiceAdventure( 774, "Opening up the Folder Holder", "Item-Driven" )
		{
			...
			void postChoice1( GenericRequest request, int decision )
			{
				...
				if ( decision == 1 && request.responseText.contains( "You carefully place your new folder in the holder" ) )
				{
		...
		new ChoiceAdventure( 780, "Action Elevator", "The Hidden Apartment Building" )
		{
			...
			void visitChoice( GenericRequest request )
			{
				...
				pygmyLawyersRelocated = Preferences.getInteger( "relocatePygmyLawyer" ) == KoLCharacter.getAscensions();
				...
				if ( hiddenApartmentProgress < 7 )
				{
					...
					{
						option.text( "Need Thrice-Cursed to fight ancient protector spirit" ).attachEffect( CURSE3_EFFECT, new ImageOnly( "Cursed" ) );
					}
				}
				else
				{
				...
				getOption( 3 ).text( pygmyLawyersRelocated ? "Waste adventure" :
			...
			String getDecision( String responseText, String decision, int stepCount )
			{
				...
				{
					return hiddenApartmentProgress >= 7 ? "6" :
						hasThriceCursed ? "1" : "2";
				}
		...
		new ChoiceAdventure( 781, "Earthbound and Down", "An Overgrown Shrine (Northwest)" )
		{
			void setup()
			{
				...
				new Option( 1, "Unlock Hidden Apartment Building" )
					.turnCost( 1 );
		...
		new ChoiceAdventure( 783, "Water You Dune", "An Overgrown Shrine (Southwest)" )
		{
			void setup()
			{
				...
				new Option( 1, "Unlock Hidden Hospital" )
					.turnCost( 1 );
				new Option( 2, "Get stone triangle" )
					.attachItem( ItemPool.STONE_TRIANGLE, 1, AUTO )
		...
		new ChoiceAdventure( 785, "Air Apparent", "An Overgrown Shrine (Northeast)" )
		{
			void setup()
			{
				...
				new Option( 1, "Unlock Hidden Office Building" )
					.turnCost( 1 );
				new Option( 2, "Get stone triangle" )
					.attachItem( ItemPool.STONE_TRIANGLE, 1, AUTO )
		...
		new ChoiceAdventure( 786, "Working Holiday", "The Hidden Office Building" )
		{
			...
			void setup()
			{
				...
				new Option( 2, "Get boring binder clip" )
					.turnCost( 1 );
			...
			void visitChoice( GenericRequest request )
			{
				...
				{
					option.attachItem( MCCLUSKY_FILE, AUTO, new DisplayAll( "\\(complete\\)", NEED, AT_LEAST, 1 ) );
				}
				else
				{
			...
			void postChoice2( GenericRequest request, int decision )
			{
				if ( decision == 1 )
				{
					...
					if ( hiddenOfficeProgress < 7 &&
					     request.responseText.contains( "boss's office is empty" ) )
					{
				...
				else if ( decision == 2 )
				{
					...
					if ( !request.responseText.contains( "boring binder clip" ) &&
					     !hasMcCluskyFile && !hasBinderClip && hiddenOfficeProgress < 6 )
					{
		...
		new ChoiceAdventure( 787, "Fire When Ready", "An Overgrown Shrine (Southeast)" )
		{
			void setup()
			{
				...
				new Option( 1, "Unlock Hidden Bowling Alley" )
					.turnCost( 1 );
				new Option( 2, "Get stone triangle" )
					.attachItem( ItemPool.STONE_TRIANGLE, 1, AUTO )
		...
		new ChoiceAdventure( 788, "Life is Like a Cherry of Bowls", "The Hidden Bowling Alley" )
		{
			...
			void visitChoice( GenericRequest request )
			{
				...
				getOption( 1 ).text( hiddenBowlingAlleyProgress > 6 ?
					"Get stats" :
		...
		new ChoiceAdventure( 789, "Where Does The Lone Ranger Take His Garbagester?", "The Hidden Park" )
		{
			...
			void setup()
			{
				...
				new Option( 2, "Relocate pygmy janitors to Hidden Park" )
					.turnCost( 1 );
				new Option( 6, "skip adventure", true )
					.entersQueue( false );
			...
			void visitChoice( GenericRequest request )
			{
				pygmyJanitorsRelocated = Preferences.getInteger( "relocatePygmyJanitor" ) == KoLCharacter.getAscensions();
		...
		new ChoiceAdventure( 791, "Legend of the Temple in the Hidden City", "A Massive Ziggurat" )
		{
			...
			String getDecision( String responseText, String decision, int stepCount )
			{
				...
				if ( decision.equals( "1" ) &&
				     InventoryManager.getCount( STONE_TRIANGLE ) < 4 )
				{
					return "6";
				}
				return decision;
		...
		new ChoiceAdventure( 795, "The Bathroom of Ten Men", "The Old Landfill" )
		{
			void setup()
			{
				...
				new Option( 1, null, true )
					.turnCost( 1 )
					.attachItem( "old claw-foot bathtub", 1, AUTO );
		...
		new ChoiceAdventure( 796, "The Den of Iquity", "The Old Landfill" )
		{
			void setup()
			{
				...
				new Option( 2, null, true )
					.turnCost( 1 )
					.attachItem( "old clothesline pole", 1, AUTO );
		...
		new ChoiceAdventure( 797, "Let's Workshop This a Little", "The Old Landfill" )
		{
			void setup()
			{
				...
				new Option( 1, "Junk-Bond", true )
					.turnCost( 1 )
					.attachItem( "Junk-Bond", 1, AUTO );
				new Option( 2, "make lots of noise", true );
				new Option( 3, null, true )
					.turnCost( 1 )
					.attachItem( "antique cigar sign", 1, AUTO );
			}
	...
	static final String ghostPencilDecisionRedirect( String responseText, String decision, String setting )
	{
