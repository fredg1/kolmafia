...
class CADatabase800to899 extends ChoiceAdventureDatabase
{
	final void add800to899()
	{
		...
		new ChoiceAdventure( 801, "A Reanimated Conversation", "Item-Driven" )
		{
			...
			final Pattern REANIMATOR_WEIRDPART_PATTERN = Pattern.compile( "(\\d+) weird random parts??<br>" );
		...
		new RetiredChoiceAdventure( 803, "Behind the Music.  Literally.", "The Space Odyssey Discotheque" )
		{
			void setup()
			{
				new Option( 1, "gain 2-3 horoscopes", true )
					.turnCost( 1 );
				new Option( 3, "find interesting room", true )
					.turnCost( 1 );
				new Option( 4, "investigate interesting room", true )
					.turnCost( 1 );
		...
		new RetiredChoiceAdventure( 810, "K.R.A.M.P.U.S. facility", null )
		{
			...
			void setup()
			{
				...
				new Option( 1 );
				new Option( 2 )
					.attachItem( ItemPool.WARBEAR_WHOSIT, -100, MANUAL );
				new Option( 3 );
				new Option( 4 );
			}
		...
		{
			final Pattern UNPERM_PATTERN = Pattern.compile( "Turning (.+)(?: \\(HP\\)) into (\\d+) karma." );
		...
		new RetiredChoiceAdventure( 813, "What Warbears Are Good For", "WarBear Fortress (First Level)" )
		{
			void setup()
			{
		...
		new ChoiceAdventure( 827, "The Prince's Ball (At the Canapés Table)", "The Prince's Canapes Table" )
		{
			void setup()
			{
				//options are assigned dynamically, and contain sub-choices...
		...
		new ChoiceAdventure( 830, "Cooldown", "The Inner Wolf Gym" )
		{
			void setup()
			{
				...
				new Option( 1, "Shower Power", true )
					.leadsTo( 832, false, ( Option o ) -> true, " or " );
				new Option( 2, "Vendie, Vidi, Vici", true )
					.leadsTo( 833, false, ( Option o ) -> true, " or " );
				new Option( 3, "Back Room Dealings", true )
					.leadsTo( 834, false, ( Option o ) -> true, " or " );
		...
		new ChoiceAdventure( 832, "Shower Power", "The Inner Wolf Gym" )
		{
			void setup()
			{
				...
				new Option( 1, "+Wolf Offence", true )
					.turnCost( 1 );
				new Option( 2, "+Wolf Defence", true )
					.turnCost( 1 );
			}
		};
		...
		new ChoiceAdventure( 833, "Vendie, Vidi, Vici", "The Inner Wolf Gym" )
		{
			void setup()
			{
				...
				new Option( 1, "+Wolf Elemental Attacks", true )
					.turnCost( 1 );
				new Option( 2, "+Rabbit", true )
					.turnCost( 1 );
			}
		};
		...
		new ChoiceAdventure( 834, "Back Room Dealings", "The Inner Wolf Gym" )
		{
			void setup()
			{
				...
				new Option( 2, "Improved Howling!", true )
					.turnCost( 1 );
				new Option( 3, "+Wolf Lung Capacity", true )
					.turnCost( 1 );
			}
		};
		...
		new ChoiceAdventure( 835, "Barely Tales", "Item-Driven" )
		{
			void setup()
			{
				...
				new Option( 1, "30 adv of Soles of Glass" )
					.attachEffect( "Soles of Glass" );
				new Option( 2, "30 adv of Angry like the Wolf" )
					.attachEffect( "Angry like the Wolf" );
				new Option( 3, "30 adv of Grumpy and Ornery" )
					.attachEffect( "Grumpy and Ornery" );
		...
		new ChoiceAdventure( 837, "On Purple Pond", "Sweet-Ade Lake" )
		{
			void setup()
			{
				...
				new Option( 1, "find out the two children not invading", true )
					.turnCost( 1 );
				new Option( 2, "+1 Moat", true )
					.turnCost( 1 );
				new Option( 3, "gain Candy", true )
					.turnCost( 1 );
			}
		};
		...
		new ChoiceAdventure( 838, "General Mill", "Sweet-Ade Lake" )
		{
			void setup()
			{
				...
				new Option( 1, "+1 Moat", true )
					.turnCost( 1 );
				new Option( 2, "gain Candy", true )
					.turnCost( 1 );
			}
		};
		...
		new ChoiceAdventure( 839, "The Sounds of the Undergrounds", "Eager Rice Burrows" )
		{
			void setup()
			{
				...
				new Option( 1, "learn what the first two waves will be", true )
					.turnCost( 1 );
				new Option( 2, "+1 Minefield Strength", true )
					.turnCost( 1 );
				new Option( 3, "gain Candy", true )
					.turnCost( 1 );
			}
		...
		new ChoiceAdventure( 840, "Hop on Rock Pops", "Eager Rice Burrows" )
		{
			void setup()
			{
				...
				new Option( 1, "+1 Minefield Strength", true )
					.turnCost( 1 );
				new Option( 2, "gain Candy", true )
					.turnCost( 1 );
			}
		...
		new ChoiceAdventure( 841, "Building, Structure, Edifice", "Gumdrop Forest" )
		{
			void setup()
			{
				...
				new Option( 1, "increase candy in another location", true )
					.turnCost( 1 );
				new Option( 2, "+2 Random Defense", true )
					.turnCost( 1 );
				new Option( 3, "gain Candy", true )
					.turnCost( 1 );
			}
		...
		new ChoiceAdventure( 842, "The Gingerbread Warehouse", "Gumdrop Forest" )
		{
			void setup()
			{
				...
				new Option( 1, "+1 Wall Strength", true )
					.turnCost( 1 );
				new Option( 2, "+1 Poison Jar", true )
					.turnCost( 1 );
				new Option( 3, "+1 Anti-Aircraft Turret", true )
					.turnCost( 1 );
				new Option( 4, "gain Candy", true )
					.turnCost( 1 );
			}
		};
		...
		new ChoiceAdventure( 846, "Bartering for the Future of Innocent Children", "Portal to Terrible Parents" )
		{
			void setup()
			{
				new Option( 1 )
		...
		new ChoiceAdventure( 849, "The Practice", "Rumpelstiltskin's Workshop" )
		{
			void setup()
			{
				...
				new Option( 1 )
					.attachItem( ItemPool.FILLING );
				new Option( 2 )
					.attachItem( ItemPool.PARCHMENT );
				new Option( 3 )
					.attachItem( ItemPool.GLASS );
				new Option( 4 )
					.leadsTo( 845 );
			}
		...
		new ChoiceAdventure( 850, "World of Bartercraft", "Rumpelstiltskin's Workshop" )
		{
			void setup()
			{
				...
				// since we immediately parse them
				new Option( 1 )
					.attachItem( ItemPool.FILLING, 1, AUTO );
				new Option( 2 )
					.attachItem( ItemPool.PARCHMENT, 1, AUTO );
				new Option( 3 )
					.attachItem( ItemPool.GLASS, 1, AUTO );
				new Option( 4 )
					.leadsTo( 845 );
			}
		...
		new ChoiceAdventure( 856, "This Looks Like a Good Bush for an Ambush", "A Mob of Zeppelin Protesters" )
		{
			final Pattern LYNYRD_PATTERN = Pattern.compile( "(?:scare|group of|All) <b>(\\d+)</b> (?:of the protesters|protesters|of them)" );
			...
			void visitChoice( GenericRequest request )
			{
				...
				for ( AdventureResult ar : new AdventureResult[] { LYNYRD_CAP, LYNYRD_TUNIC, LYNYRD_BREECHES } )
				{
				...
				getOption( 1 ).text( "scare " + lynyrd + " protestors" +
					( lynyrd == 21 ? " (max)" :
					  " (more with lynyrd gear)" ) );
			}
		...
		{
			final Pattern BENCH_WARRANT_PATTERN = Pattern.compile( "creep <font color=blueviolet><b>(\\d+)</b></font> of them" );
		...
		new ChoiceAdventure( 866, "Methinks the Protesters Doth Protest Too Little", "A Mob of Zeppelin Protesters" )
		{
			void setup()
			{
				this.isSuperlikely = true;
				...
				new Option( 1 )
					.leadsTo( 856, true, ( Option o ) -> o.index == 1 );
				new Option( 2 )
					.leadsTo( 857, true, ( Option o ) -> o.index == 1 );
				new Option( 3 )
					.leadsTo( 858, false, ( Option o ) -> o.index == 1 );
		...
		new ChoiceAdventure( 873, "Rod Nevada, Vendor", "Inside the Palindome" )
		{
			...
			void postChoice1( GenericRequest request, int decision )
			{
				if ( decision == 1 && !request.responseText.contains( "had Rod not run off before you got the chance." ) )
				{
					this.choiceFailed();
				}
			}
		...
		new ChoiceAdventure( 876, "One Simple Nightstand", "The Haunted Bedroom" )
		{
			void setup()
			{
				...
				new Option( 1, "old leather wallet", true )
					.attachItem( "old leather wallet", 1, AUTO );
		...
		new ChoiceAdventure( 877, "One Mahogany Nightstand", "The Haunted Bedroom" )
		{
			...
			void visitChoice( GenericRequest request )
			{
				...
				if ( KoLCharacter.isZombieMaster() ||
					classType == KoLCharacter.GELATINOUS_NOOB ||
					...
					classType == KoLCharacter.PLUMBER )
				{
					option.text( "get nothing" );
				}
				else
				{
					option.attachItem( ItemPool.SPOOKYRAVEN_SPECTACLES, new DisplayAll( "spectacles", NEED, EQUIPPED_AT_LEAST, 1 ) );
					...
					case KoLCharacter.AVATAR_OF_BORIS:
						text += "tattered wolf standard";
						option.attachItem( ItemPool.TATTERED_WOLF_STANDARD, 1, AUTO, new DisplayAll( "standard" ) );
						break;
					case KoLCharacter.TURTLE_TAMER:
						text += "tattered snake standard";
						option.attachItem( ItemPool.TATTERED_SNAKE_STANDARD, 1, AUTO, new DisplayAll( "standard" ) );
						break;
					case KoLCharacter.PASTAMANCER:
					case KoLCharacter.SAUCEROR:
						text += "English to A. F. U. E. Dictionary";
						option.attachItem( ItemPool.ENGLISH_TO_A_F_U_E_DICTIONARY, 1, AUTO, new DisplayAll( "Dictionary" ) );
						break;
					case KoLCharacter.DISCO_BANDIT:
					case KoLCharacter.ACCORDION_THIEF:
						text += "bizarre illegible sheet music";
						option.attachItem( ItemPool.BIZARRE_ILLEGIBLE_SHEET_MUSIC, 1, AUTO, new DisplayAll( "sheet music" ) );
						break;
					default:
						text += "???";
						break;
		...
		new ChoiceAdventure( 878, "One Ornate Nightstand", "The Haunted Bedroom" )
		{
			void setup()
			{
				...
				new Option( 1, "gain ~500 meat", true )
					.attachMeat( 500, AUTO );
		...
		new ChoiceAdventure( 880, "One Elegant Nightstand", "The Haunted Bedroom" )
		{
			void setup()
			{
				...
				new Option( 2, "elegant nightstick", true )
					.attachItem( "elegant nightstick", 1, AUTO );
		...
		new ChoiceAdventure( 882, "Off the Rack", "The Haunted Bathroom" )
		{
			void setup()
			{
				...
				new Option( 1, null, true )
					.turnCost( 1 )
					.attachItem( ItemPool.TOWEL, 1, AUTO );
				new Option( 2, "waste adventure", true )
					.turnCost( 1 );
			}
		};
		...
		new ChoiceAdventure( 888, "Take a Look, it's in a Book!", "The Haunted Library" ) // Rise
		{
			void setup()
			{
				...
				new Option( 1, "background history" )
					.leadsTo( 86 );
				new Option( 2, "cooking recipe" )
					.turnCost( 1 );
				new Option( 3 )
					.leadsTo( 88, true, ( Option o ) -> true );
				new Option( 4, "skip adventure and banish both versions for 10 adventures" )
					.entersQueue( false );

				new CustomOption( 1, "boost mysticality substats", () -> {
					Preferences.setString( "choiceAdventure888", "3" );
					Preferences.setString( "choiceAdventure88", "1" );
				} );
				new CustomOption( 2, "boost moxie substats", () -> {
					Preferences.setString( "choiceAdventure888", "3" );
					Preferences.setString( "choiceAdventure88", "2" );
				} );
				new CustomOption( 3, "acquire mysticality skill", () -> {
					Preferences.setString( "choiceAdventure888", "3" );
		...
		new ChoiceAdventure( 889, "Take a Look, it's in a Book!", "The Haunted Library" ) // Fall
		{
			void setup()
			{
				...
				new Option( 1, "background history" )
					.leadsTo( 87 );
				new Option( 2, "cocktailcrafting recipe" )
					.turnCost( 1 );
				new Option( 3, "muscle substats", true )
					.turnCost( 1 );
				new Option( 4 )
					.attachItem( ItemPool.DICTIONARY, 1, AUTO, new ImageOnly() )
					.turnCost( 1 );
		...
		new ChoiceAdventure( 890, "Lights Out in the Storage Room", "The Haunted Storage Room" )
		{
			void setup()
			{
				...
				new CustomOption( 0, "show in browser", () ->
					Preferences.setInteger( "lightsOutAutomation", 0 ) );
				new CustomOption( 1, "take quest option if available", () ->
					Preferences.setInteger( "lightsOutAutomation", 1 ) );
				new CustomOption( 2, "skip adventure", () ->
					Preferences.setInteger( "lightsOutAutomation", 2 ) );
				...
				this.customLoad = () -> {
					...
					{
					default:
						System.out.println( "Invalid setting " + lightsOutIndex + " for lightsOutAutomation" );
						// fall-through
					case 0:
						return 0;
					case 1:
