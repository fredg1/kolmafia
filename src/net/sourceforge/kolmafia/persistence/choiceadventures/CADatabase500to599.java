	...
	final void add500to599()
	{
		...
		new ChoiceAdventure( 502, "Arboreal Respite", "The Spooky Forest" )
		{
			void setup()
			{
				...
				new Option( 1 )
					.leadsTo( 503, true, ( Option o ) -> true );
				new Option( 2 )
					.leadsTo( 505, true, ( Option o ) -> true );
				new Option( 3 )
					.leadsTo( 506, true, ( Option o ) -> true );

				new CustomOption( 1, "mosquito larva or spooky mushrooms", () -> {
					Preferences.setString( "choiceAdventure502", "2" );
					Preferences.setString( "choiceAdventure505", "1" );
				} );
				new CustomOption( 2, "Spooky-Gro fertilizer", () -> {
					Preferences.setString( "choiceAdventure502", "3" );
					Preferences.setString( "choiceAdventure506", "2" );
				} );
				new CustomOption( 3, "spooky sapling & sell bar skins", () -> {
				...
				new CustomOption( 4, "Spooky Temple map then skip adventure", () -> {
				...
				new CustomOption( 5, "meet vampire hunter", () -> {
					Preferences.setString( "choiceAdventure502", "1" );
					Preferences.setString( "choiceAdventure503", "2" );
				} );
				new CustomOption( 6, "meet vampire", () -> {
					Preferences.setString( "choiceAdventure502", "2" );
					Preferences.setString( "choiceAdventure505", "3" );
				} );
				new CustomOption( 7, "gain meat", () -> {
					Preferences.setString( "choiceAdventure502", "1" );
					Preferences.setString( "choiceAdventure503", "1" );
				} );
				new CustomOption( 8, "loot Seal Clubber corpse", () -> {
					Preferences.setString( "choiceAdventure502", "3" );
				...
				this.customLoad = () -> {
					...
					case 3:
						...
						case 1: // Forest Corpses
							...
							{
							default:
								System.out.println( "Invalid setting " + index26 + " for choiceAdventure26" );
							case 0:
								return 0;
							case 1: // muscle classes
								...
								{
								default:
									System.out.println( "Invalid setting " + index27 + " for choiceAdventure27" );
								case 0:
									return 0;
								case 1:
									return 8;
							...
							case 2: // mysticality classes
								...
								{
								default:
									System.out.println( "Invalid setting " + index28 + " for choiceAdventure28" );
								case 0:
									return 0;
								case 1:
									return 10;
							...
							case 3: // moxie classes
								...
								{
								default:
									System.out.println( "Invalid setting " + index29 + " for choiceAdventure29" );
								case 0:
									return 0;
								case 1:
									return 12;
		...
		new ChoiceAdventure( 503, "The Road Less Traveled", "The Spooky Forest" )
		{
			...
			void visitChoice( GenericRequest request )
			{
				...
				{
					option.text( "trade vampire hearts" )
						.attachItem( VAMPIRE_HEART )
						.leadsTo( 47, true );
				}
				else if ( WOODEN_STAKES.getCount( KoLConstants.inventory ) == 0 )
				{
					option.text( "get wooden stakes" )
						.turnCost( 1 )
		...
		new ChoiceAdventure( 504, "Tree's Last Stand", "The Spooky Forest" )
		{
			...
			final Pattern BAR_SKIN_PATTERN = Pattern.compile( "Sell him all your bar skins for (\\d+) Meat" );

			void setup()
			{
				new Option( 1 )
					.attachItem( BAR_SKIN.getInstance( 1 ), MANUAL )
					.attachMeat( 75, AUTO );
				new Option( 2 );
				new Option( 3, "buy spooky sapling" )
					.attachItem( ItemPool.SPOOKY_SAPLING, 1, AUTO )
					.attachMeat( -100, MANUAL );
				new Option( 4, "end this adventure" )
					.turnCost( 1 );
			}
			...
			void visitChoice( GenericRequest request )
			{
				...
				option.attachMeat( skins * 75, AUTO )
					.attachItem( BAR_SKIN.getInstance( -skins ), MANUAL );
			}
		...
		new ChoiceAdventure( 505, "Consciousness of a Stream", "The Spooky Forest" )
		{
			...
			void setup()
			{
				...
				new Option( 2 );
				new Option( 3 )
					.leadsTo( 46, false, ( Option o ) -> true );
			}
			...
			void visitChoice( GenericRequest request )
			{
				...
				{
					option.text( "mosquito larva" )
						.attachItem( ItemPool.MOSQUITO_LARVA, 1, AUTO );
				}
				else
				{
					option.text( "3 spooky mushrooms" )
						.attachItem( SPOOKY_MUSHROOMS, AUTO );
				}
				...
				{
					// remove the filter
					getOption( 3 ).reset( "get stats or fight a spooky vampire" )
						.leadsTo( 46 );
				}
			}
		};
		...
		new ChoiceAdventure( 506, "Through Thicket and Thinnet", "The Spooky Forest" )
		{
			void setup()
			{
				new Option( 1, "gain a class's starter items" )
					.leadsTo( 26 );
		...
		new ChoiceAdventure( 522, "Welcome to the Footlocker", "Cobb's Knob Barracks" )
		{
			void setup()
			{
				new Option( 1, "outfit piece or donut", true )
					.turnCost( 1 );
				new Option( 2, "skip adventure", true )
					.entersQueue( false );
			}
			...
			void visitChoice( GenericRequest request )
			{
				...
				if ( !havePolearm )
				{
					option.text( "knob goblin elite polearm" )
						.attachItem( ItemPool.KNOB_GOBLIN_POLEARM, 1, AUTO );
				}
				else if ( !havePants )
				{
					option.text( "knob goblin elite pants" )
						.attachItem( ItemPool.KNOB_GOBLIN_PANTS, 1, AUTO );
				}
				else if ( !haveHelm )
				{
					option.text( "knob goblin elite helm" )
						.attachItem( ItemPool.KNOB_GOBLIN_HELM, 1, AUTO );
				}
				else
				{
					option.text( "knob jelly donut" )
						.attachItem( ItemPool.KNOB_DONUT, 1, AUTO );
				}
			}
		};
		...
		new ChoiceAdventure( 523, "Death Rattlin'", "The Defiled Cranny" )
		{
			void setup()
			{
				new Option( 1, "small meat boost", true )
					.turnCost( 1 )
					.attachMeat( 250, AUTO );
				new Option( 2, "stats & HP & MP", true )
					.turnCost( 1 );
				...
				new Option( 5, "skip adventure", true )
					.entersQueue( false );
			}
		};
		...
		new RetiredChoiceAdventure( 528, "It Was Then That a Hideous Monster Carried You", "The Icy Peak" )
		{
			void setup()
			{
				new Option( 1 );
		...
		new RetiredChoiceAdventure( 529, "A Swarm of Yeti-Mounted Skeletons", "A Swarm of Yeti-Mounted Skeletons" )
		{
			void setup()
			{
		...
		new RetiredChoiceAdventure( 534, "That's No Bone Moon...", "The Bone Star" )
		{
			void setup()
			{
				new Option( 1, "Torpedoes", true )
					.attachItem( "photoprotoneutron torpedo", -1, AUTO );
		...
		new ChoiceAdventure( 549, "Dark in the Attic", "The Haunted Sorority House" )
		{
			void setup()
			{
				...
				new Option( 1 )
					.attachItem( ItemPool.STAFF_GUIDE, 3, AUTO );
				new Option( 2 )
					.attachItem( "ghost trap", 1, AUTO );
			...
			void postChoice1( GenericRequest request, int decision )
			{
				if ( request.responseText.contains( "The silver pellets tear through the sorority werewolves" ) )
				{
		...
		new ChoiceAdventure( 550, "The Unliving Room", "The Haunted Sorority House" )
		{
			...
			void postChoice1( GenericRequest request, int decision )
			{
				...
				else if ( request.responseText.contains( "the skeletons collapse into piles of loose bones" ) )
				{
		...
		new ChoiceAdventure( 551, "Debasement", "The Haunted Sorority House" )
		{
			void setup()
			{
				...
				new Option( 1, "Prop Deportment", true )
					.leadsTo( 552 );
		...
		new ChoiceAdventure( 552, "Prop Deportment", "The Haunted Sorority House" )
		{
			void setup()
			{
				...
				new Option( 1 )
					.attachItem( ItemPool.CHAINSAW_CHAIN, 1, AUTO );
				new Option( 2, "create a silver shotgun shell" )
					.leadsTo( 553 )
					.attachItem( ItemPool.SILVER_SHOTGUN_SHELL );
				new Option( 3 )
					.attachItem( ItemPool.FUNHOUSE_MIRROR, 1, AUTO );
		...
		new ChoiceAdventure( 554, "Behind the Spooky Curtain", "The Haunted Sorority House" )
		{
			void setup()
			{
				...
				new Option( 1, "staff guides, ghost trap, kill werewolves" )
					.leadsTo( 549 );
				new Option( 2, "kill zombies, kill skeletons, costume item" )
					.leadsTo( 550 );
				new Option( 3, "chainsaw chain, silver item, funhouse mirror, kill vampires" )
					.leadsTo( 551 );
		...
		new RetiredChoiceAdventure( 557, "Gingerbread Homestead", "Lollipop Forest" )
		{
			void setup()
			{
				...
				new Option( 1, "get 3-5 candies", true )
					.turnCost( 1 );
				new Option( 2, "licorice root", true )
					.turnCost( 1 )
					.attachItem( "licorice root", 1, AUTO );
				new Option( 3, "skip adventure or make a lollipop stick item", true )
					.leadsTo( 558 );
			}
		};
		...
		new RetiredChoiceAdventure( 559, "Fudge Mountain Breakdown", "Fudge Mountain" )
		{
			void setup()
			{
				...
				new Option( 1, "fudge lily", true )
					.turnCost( 1 )
					.attachItem( "fudge lily", 1, AUTO );
		...
		new ChoiceAdventure( 562, "You're the Fudge Wizard Now, Dog", "Item-Driven" )
		{
			void setup()
			{
				...
				new Option( 1 )
					.attachItem( ItemPool.FUDGIE_ROLL, 1, AUTO );
				new Option( 2 )
					.attachItem( ItemPool.FUDGE_SPORK, 1, AUTO );
				new Option( 3 )
					.attachItem( ItemPool.FUDGE_CUBE, 1, AUTO );
				new Option( 4 )
					.attachItem( ItemPool.FUDGE_BUNNY, 1, AUTO );
				new Option( 5 )
					.attachItem( ItemPool.FUDGECYCLE, 1, AUTO );
				new Option( 6 );
			}
		};
		...
		new ChoiceAdventure( 575, "Duffel on the Double", "The eXtreme Slope" )
		{
			void setup()
			{
				...
				new Option( 3, "skip adventure", true )
					.entersQueue( false );
				new Option( 4, "lucky pill", true )
					.turnCost( 1 )
					.attachItem( "lucky pill", 1, AUTO );
		...
		new ChoiceAdventure( 579, "Such Great Heights", "The Hidden Temple" )
		{
			void setup()
			{
				...
				new Option( 1, "mysticality substats", true )
					.turnCost( 1 );
			...
			void visitChoice( GenericRequest request )
			{
				...
				{
					option.text( "gain the Nostril of the Serpent" )
						.turnCost( 1 )
				...
				{
					option.text( "gain 3 adventures and extend 10 of your buffs by 3 turns" )
						.attachAdv( 3 );
				}
				else
				{
			...
			void postChoice2( GenericRequest request, int decision )
			{
				if ( decision == 3 && Preferences.getInteger( "lastTempleAdventures" ) != KoLCharacter.getAscensions() )
				{
		...
		{
			final AdventureResult NOSTRIL_OF_THE_SERPENT = ItemPool.get( ItemPool.NOSTRIL_OF_THE_SERPENT, -1 );
			final AdventureResult ANCIENT_CALENDAR_FRAGMENT = new AdventureResult( "ancient calendar fragment", 1, false );
			...
			void visitChoice( GenericRequest request )
			{
				...
				if ( request != null )
				{
					...
					else if ( request.responseText.contains( "door_pikachu.gif" ) )
					{
						...
						option.text( "unlock Hidden City (3)" )
							.leadsTo( 123 );
					}
				}
				...
				{
					option.text( "choose Hidden Heart adventure (doesn't end this adventure)" )
						.leadsTo( 584 )
						.attachItem( NOSTRIL_OF_THE_SERPENT, MANUAL );
				}
				else if ( Preferences.getInteger( "lastTempleButtonsUnlock" ) == KoLCharacter.getAscensions() )
				{
					option.text( "choose Hidden Heart adventure (doesn't end this adventure)" )
						.leadsTo( 584 );
				}
				...
				{
					option.text( "randomise Hidden Heart adventure (will be able to choose it for free if you get the Nostril of the Serpent)" )
						.leadsTo( 583 )
		...
		new ChoiceAdventure( 581, "Such Great Depths", "The Hidden Temple" )
		{
			...
			void visitChoice( GenericRequest request )
			{
				...
				{
					option.text( "5 advs of Hidden Power" )
						.turnCost( 1 )
						.attachEffect( HIDDEN_POWER );
				}
			}
		...
		new ChoiceAdventure( 582, "Fitting In", "The Hidden Temple" )
		{
			void setup()
			{
				...
				new Option( 1 )
					.leadsTo( 579, true, ( Option o ) -> !o.spoilerText.equals( "skip adventure" ) );
				new Option( 2, "Hidden Heart of the Hidden Temple", true )
					.leadsTo( 580, true );
				new Option( 3 )
					.leadsTo( 581, true, ( Option o ) -> !o.spoilerText.equals( "skip adventure" ) );
		...
		new ChoiceAdventure( 583, "Confusing Buttons", "The Hidden Temple" )
		{
			void setup()
			{
				new Option( 1, "Press a random button" )
					.turnCost( 1 );
			}
		};
		...
		new ChoiceAdventure( 591, "The Beginning of the Beginning of the End", null ) // "Bridge" is not actually a zone
		{
			void setup()
			{
				new Option( 1 )
		...
		new ChoiceAdventure( 594, "A Lost Room", "Item-Driven" )
		{
			void setup()
			{
				...
				new Option( 1, null, true )
					.attachItem( ItemPool.LOST_GLASSES, 1, AUTO, new NoDisplay() );
				new Option( 2, null, true )
					.attachItem( "lost comb", 1, AUTO, new NoDisplay() );
				new Option( 3, null, true )
					.attachItem( "lost pill bottle", 1, AUTO, new NoDisplay() );
			}
		...
		new ChoiceAdventure( 599, "A Zombie Master's Bait", null )
		{
			...
			void setup()
			{
				new Option( 1, "1 zombie each" )
					.attachItem( CRAPPY_BRAIN );
				new Option( 2, "2 zombies each" )
					.attachItem( DECENT_BRAIN );
				new Option( 3, "3 zombies each" )
					.attachItem( GOOD_BRAIN );
				new Option( 4, "6 zombies each" )
					.attachItem( BOSS_BRAIN );
				new Option( 5 );
			}
