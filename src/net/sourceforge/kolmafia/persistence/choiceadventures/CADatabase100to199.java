...
class CADatabase100to199 extends ChoiceAdventureDatabase
{
	...
	{
		new RetiredChoiceAdventure( 100, "Louvre It or Leave It", "The Haunted Gallery" ) // The Death of Socrates
		{
			void setup()
			{
				new Option( 1 );
		...
		new RetiredChoiceAdventure( 102, "Louvre It or Leave It", "The Haunted Gallery" ) // Sunday Afternoon on the Island of La Grande Jatte
		{
			void setup()
			{
				new Option( 1 );
		...
		new RetiredChoiceAdventure( 103, "Louvre It or Leave It", "The Haunted Gallery" ) // The Last Supper
		{
			void setup()
			{
				new Option( 1 );
		...
		new RetiredChoiceAdventure( 104, "Louvre It or Leave It", "The Haunted Gallery" ) // The Persistence of Memory
		{
			void setup()
			{
				new Option( 1 );
		...
		new ChoiceAdventure( 105, "Having a Medicine Ball", "The Haunted Bathroom" )
		{
			void setup()
			{
				...
				new Option( 2 )
					.leadsTo( 107, false, ( Option o ) -> true );
			...
			void visitChoice( GenericRequest request )
			{
				...
				getOption( 1 ).text( "get " + mystGain + " mysticality substats (antique hand mirror " +
					( haveMirror ? "" : "NOT " ) + "in inventory)" );

				getOption( 3 ).text( !defeated ?
					"guy made of bees: called " + Preferences.getString( "guyMadeOfBeesCount" ) + "/5 times" :
			...
			void postChoice1( GenericRequest request, int decision )
			{
				if ( decision == 3 )
				{
					...
					// You say "Guy made of bees" into the mirror, but nothing happens. Looks like that ship is sailed. And the ship was made of bees, and it sailed in the air.
		...
		new ChoiceAdventure( 106, "Strung-Up Quartet", "The Haunted Ballroom" )
		{
			void setup()
			{
				new Option( 1, "increase monster level", true )
					.turnCost( 1 );
				new Option( 2, "decrease combat frequency", true )
					.turnCost( 1 );
				new Option( 3, "increase item drops", true )
					.turnCost( 1 );
				new Option( 4, "disable song", true )
					.entersQueue( false );
			}
		...
		new ChoiceAdventure( 107, "Bad Medicine is What You Need", "The Haunted Bathroom" )
		{
			void setup()
			{
				new Option( 1, null, true )
					.turnCost( 1 )
					.attachItem( "antique bottle of cough syrup", 1, AUTO );
				new Option( 2, null, true )
					.turnCost( 1 )
					.attachItem( "tube of hair oil", 1, AUTO );
				new Option( 3, null, true )
					.turnCost( 1 )
					.attachItem( "bottle of ultravitamins", 1, AUTO );
		...
		new ChoiceAdventure( 108, "Aww, Craps", "The Sleazy Back Alley" )
		{
			void setup()
			{
				new Option( 1, "moxie substats", true )
					.turnCost( 1 );
				new Option( 2, "meat and moxie", true )
					.turnCost( 1 )
					.attachMeat( 35, AUTO );
				new Option( 3, "random effect", true )
					.turnCost( 1 );
				new Option( 4, "skip adventure", true )
					.entersQueue( false );
			}
		...
		new ChoiceAdventure( 109, "Dumpster Diving", "The Sleazy Back Alley" )
		{
			void setup()
			{
				...
				new Option( 2, "meat and moxie", true )
					.turnCost( 1 )
					.attachMeat( 3, AUTO );
				new Option( 3, "Mad Train wine", true )
					.turnCost( 1 )
					.attachItem( "Mad Train wine", 1, AUTO );
			}
		};
		...
		new ChoiceAdventure( 110, "The Entertainer", "The Sleazy Back Alley" )
		{
			void setup()
			{
				new Option( 1, "moxie substats", true )
					.turnCost( 1 );
				new Option( 2, "moxie and muscle", true )
					.turnCost( 1 );
				new Option( 3, "small meat boost", true )
					.turnCost( 1 )
					.attachMeat( 15, AUTO );
				new Option( 4, "skip adventure", true )
					.entersQueue( false );
		...
		new ChoiceAdventure( 111, "Malice in Chains", "The Outskirts of Cobb's Knob" )
		{
			void setup()
			{
				new Option( 1, "muscle substats", true )
					.turnCost( 1 );
				new Option( 2, "muscle substats, risk of missing", true )
					.turnCost( 1 );
		...
		new ChoiceAdventure( 113, "Knob Goblin BBQ", "The Outskirts of Cobb's Knob" )
		{
			void setup()
			{
				...
				new Option( 3, "get a random item", true )
					.turnCost( 1 );
			}
		...
		new ChoiceAdventure( 114, "The Baker's Dilemma", "The Haunted Pantry" )
		{
			void setup()
			{
				...
				new Option( 2, "skip adventure", true )
					.entersQueue( false );
				new Option( 3, "moxie and meat (1)", true )
					.turnCost( 1 )
					.attachMeat( 15, AUTO );
			}
		};
		...
		new ChoiceAdventure( 115, "Oh No, Hobo", "The Haunted Pantry" )
		{
			void setup()
			{
				...
				new Option( 2, null, true )
					.turnCost( 1 )
					.attachMeat( -5, MANUAL )
					.attachEffect( "Good Karma" );
				new Option( 3, "mysticality, moxie, and meat", true )
					.turnCost( 1 )
					.attachMeat( 7, AUTO );
			}
		};
		...
		new ChoiceAdventure( 116, "The Singing Tree", "The Haunted Pantry" )
		{
			void setup()
			{
				new Option( 1, "mysticality substats", true )
					.turnCost( 1 )
					.attachMeat( -1, MANUAL );
				new Option( 2, "moxie substats", true )
					.turnCost( 1 )
					.attachMeat( -1, MANUAL );
				new Option( 3, "random effect", true )
					.turnCost( 1 )
		...
		new RetiredChoiceAdventure( 120, "Ennui is Wasted on the Young", "The Outskirts of Cobb's Knob" )
		{
			void setup()
			{
				new Option( 1, "muscle and Pumped Up", true )
					.turnCost( 1 );
				new Option( 2, null, true )
					.turnCost( 1 )
					.attachItem( "ice-cold Sir Schlitz", 1, AUTO );
				new Option( 3, "moxie and lemon", true )
					.turnCost( 1 )
					.attachItem( "lemon", 1, AUTO );
				new Option( 4, "skip adventure", true )
					.entersQueue( false );
			}
		};
		...
		new ChoiceAdventure( 123, "At Least It's Not Full Of Trash", "The Hidden Temple" )
		{
			void setup()
			{
				...
				new Option( 2, "Unlock Quest Puzzle" )
					.turnCost( 1 );
		...
		new ChoiceAdventure( 125, "No Visible Means of Support", "The Hidden Temple" )
		{
			void setup()
			{
				...
				new Option( 3, "Unlock Hidden City" )
					.turnCost( 1 );
			}
		...
		new ChoiceAdventure( 127, "No sir, away!  A papaya war is on!", "Inside the Palindome" )
		{
			...
			void setup()
			{
				...
				new Option( 2, "3 papayas -> stats" )
					.turnCost( 1 )
					.attachItem( PAPAYA.getInstance( -3 ), MANUAL, new DisplayAll( "papayas", NEED, AT_LEAST, 3 ) );
				new Option( 3, "stats" )
					.turnCost( 1 );
		...
		new RetiredChoiceAdventure( 134, "Wheel in the Pyramid, Keep on Turning", "The Middle Chamber" ) // initial visit
		{
			void setup()
			{
				new Option( 1 );
		...
		new RetiredChoiceAdventure( 135, "Wheel in the Pyramid, Keep on Turning", "The Middle Chamber" ) // subsequent visits
		{
			void setup()
			{
				new Option( 1 );
		...
		new ChoiceAdventure( 136, "Peace Wants Love", "Hippy Camp" )
		{
			void setup()
			{
				new Option( 1, "filthy corduroys", true )
					.turnCost( 1 )
					.attachItem( "filthy corduroys", 1, AUTO );
		...
		new ChoiceAdventure( 137, "An Inconvenient Truth", "Hippy Camp" )
		{
			void setup()
			{
				new Option( 1, "filthy knitted dread sack", true )
					.turnCost( 1 )
					.attachItem( "filthy knitted dread sack", 1, AUTO );
				new Option( 2, "filthy corduroys", true )
					.turnCost( 1 )
					.attachItem( "filthy corduroys", 1, AUTO );
				new Option( 3, "small meat boost", true )
					.turnCost( 1 )
		...
		new ChoiceAdventure( 139, "Bait and Switch", "Wartime Hippy Camp (Frat Disguise)" )
		{
			void setup()
			{
				new Option( 1, "muscle substats", true )
					.turnCost( 1 );
				new Option( 2, "2-5x ferret bait", true )
					.turnCost( 1 )
					.attachItem( "ferret bait", 2, AUTO );
		...
		new ChoiceAdventure( 141, "Blockin' Out the Scenery", "Wartime Hippy Camp (Frat Disguise)" ) // Frat Boy Ensemble
		{
			void setup()
			{
				new Option( 1, "mysticality substats", true )
				...
				new Option( 3, "waste a turn", true )
					.turnCost( 1 );
			}
		};

		new ChoiceAdventure( 142, "Blockin' Out the Scenery", "Wartime Hippy Camp (Frat Disguise)" ) // Frat Warrior Fatigues
		{
			void setup()
			{
				new Option( 1, "mysticality substats", true )
				...
				new Option( 2, "get some hippy food", true )
					...
					.attachItem( "mixed wildflower greens", 1, AUTO, new ImageOnly() )
					.attachItem( "thistle wine", 1, AUTO, new ImageOnly() );
				new Option( 3, "start the war", true )
					.turnCost( 1 );
			}
		...
		new ChoiceAdventure( 143, "Catching Some Zetas", "Wartime Frat House (Hippy Disguise)" )
		{
			void setup()
			{
				new Option( 1, "muscle substats", true )
					.turnCost( 1 );
				new Option( 2, "6-7x sake bomb", true )
					.turnCost( 1 )
					.attachItem( "sake bomb", 6, AUTO );
				new Option( 3, "fight War Pledge", true );
			}
		};

		new ChoiceAdventure( 144, "One Less Room Than In That Movie", "Wartime Frat House (Hippy Disguise)" )
		{
			void setup()
			{
				new Option( 1, "moxie substats", true )
					.turnCost( 1 );
				new Option( 2, "2-5x beer bomb", true )
					.turnCost( 1 )
					.attachItem( "beer bomb", 2, AUTO );
				new Option( 3, "fight Frat Warrior drill sergeant", true );
			}
		};

		new ChoiceAdventure( 145, "Fratacombs", "Wartime Frat House (Hippy Disguise)" ) // Filthy Hippy Disguise
		{
			void setup()
			{
				new Option( 1, "muscle substats", true )
		...
		new ChoiceAdventure( 146, "Fratacombs", "Wartime Frat House (Hippy Disguise)" ) // War Hippy Fatigues
		{
			void setup()
			{
				new Option( 1, "muscle substats", true )
		...
		new ChoiceAdventure( 147, "Cornered!", "McMillicancuddy's Barn" )
		{
			void setup()
			{
				new Option( 1, "Open The Granary (meat)", true )
					.turnCost( 1 );
				new Option( 2, "Open The Bog (stench)", true )
					.turnCost( 1 );
				new Option( 3, "Open The Pond (cold, tornado path)", true )
					.turnCost( 1 );
			}
		...
		new ChoiceAdventure( 148, "Cornered Again!", "McMillicancuddy's Barn" )
		{
			void setup()
			{
				new Option( 1, "Open The Back 40 (hot, tornado path)", true )
					.turnCost( 1 );
				new Option( 2, "Open The Family Plot (spooky)", true )
					.turnCost( 1 );
			}
		...
		new ChoiceAdventure( 149, "How Many Corners Does this Stupid Barn Have!?", "McMillicancuddy's Barn" )
		{
			void setup()
			{
				new Option( 1, "Open The Shady Thicket (booze)", true )
					.turnCost( 1 );
				new Option( 2, "Open The Other Back 40 (sleaze, tornado path)", true )
					.turnCost( 1 );
			}
		...
		new ChoiceAdventure( 151, "Adventurer, $1.99", "The \"Fun\" House" )
		{
			void setup()
			{
				...
				new Option( 1, "fight the clownlord (with 4+ clownosity)", true )
					.leadsTo( 152 );
		...
		new ChoiceAdventure( 153, "Turn Your Head and Coffin", "The Defiled Alcove" )
		{
			void setup()
			{
				new Option( 1, "muscle substats", true )
					.turnCost( 1 );
				new Option( 2, "small meat boost", true )
					.turnCost( 1 )
					.attachMeat( 250, AUTO );
		...
		new ChoiceAdventure( 155, "Skull, Skull, Skull", "The Defiled Nook" )
		{
			void setup()
			{
				...
				new Option( 2, "small meat boost", true )
					.turnCost( 1 )
					.attachMeat( 250, AUTO );
				new Option( 3, "rusty bonesaw", true )
					.turnCost( 1 )
					.attachItem( "rusty bonesaw", 1, AUTO );
		...
		new RetiredChoiceAdventure( 162, "Between a Rock and Some Other Rocks", "The Goatlet" )
		{
			...
			String getDecision( String responseText, String decision, int stepCount )
			{
				...
				return decision.equals( "2" ) ? "2" :
					wearsMiningOutfit ? "1" :
					KoLCharacter.inFistcore() && hasEarthenFist ? "1" :
		...
		new ChoiceAdventure( 163, "Melvil Dewey Would Be Ashamed", "The Haunted Library" )
		{
			void setup()
			{
				...
				new Option( 3, "Sinful Desires", true )
					.turnCost( 1 )
					.attachItem( "Sinful Desires", 1, AUTO );
				new Option( 4, "skip adventure", true );
			}
		};
		...
		new ChoiceAdventure( 165, "Beyond Any Measure", "The Stately Pleasure Dome" )
		{
			void setup()
			{
				...
				new Option( 3, "mysticality substats", true )
					.turnCost( 1 );
				new Option( 4, "skip adventure", true );
			}
		...
		new ChoiceAdventure( 169, "A Few Chintz Curtains, Some Throw Pillows...", "The Mouldering Mansion" )
		{
			void setup()
			{
				this.isSuperlikely = true;
		...
		new ChoiceAdventure( 170, "La Vie Boheme", "The Rogue Windmill" )
		{
			void setup()
			{
				...
				new Option( 1, "HP & Rat-Faced", true )
					.turnCost( 1 )
					.attachEffect( "Rat-Faced" );
		...
		new ChoiceAdventure( 180, "A Pre-War Dresser Drawer, Pa!", "Inside the Palindome" )
		{
			void setup()
			{
				new Option( 1, "Ye Olde Navy Fleece or meat", true )
					.turnCost( 1 )
					.attachMeat( 250, AUTO );
				new Option( 2, "skip adventure", true )
					.entersQueue( false );
			...
			void visitChoice( GenericRequest request )
			{
				...
				{
					option.attachItem( "Ye Olde Navy Fleece", 1, AUTO, new DisplayAll( "Fleece", WANT, INV_ONLY, 0 ) );
				}
				else
				{
		...
		new ChoiceAdventure( 181, "Chieftain of the Flies", "The Orcish Frat House (Bombed Back to the Stone Age)" )
		{
			...
			void visitChoice( GenericRequest request )
			{
				...
				getOption( 1 )
					.attachItem( SPANISH_FLY.getInstance( trades * -5 ), MANUAL, new DisplayAll( "spanish fly", WANT, AT_LEAST, 5 ) )
		...
		new ChoiceAdventure( 182, "Random Lack of an Encounter", "The Penultimate Fantasy Airship" )
		{
			...
			void setup()
			{
				...
				new Option( 3, "stats", true )
					.turnCost( 1 );
				new Option( 4, "model airship" )
					.turnCost( 1 )
					.attachItem( MODEL_AIRSHIP, AUTO );
		...
		new ChoiceAdventure( 184, "That Explains All The Eyepatches", "Barrrney's Barrr" )
		{
			...
			void visitChoice( GenericRequest request )
			{
				...
				{
					option.text( "shot of rotgut (varies by class)" )
						.attachItem( ItemPool.ROTGUT, 1, AUTO );
				}
		...
		new ChoiceAdventure( 185, "Yes, You're a Rock Starrr", "Barrrney's Barrr" )
		{
			void setup()
			{
				new Option( 1, "base booze", true )
					.turnCost( 1 );
				new Option( 2, "mixed booze", true )
					.turnCost( 1 );
		...
		new ChoiceAdventure( 186, "A Test of Testarrrsterone", "Barrrney's Barrr" )
		{
			void setup()
			{
				new Option( 1, "stats", true )
					.turnCost( 1 );
				new Option( 2, "3 drunkenness and stats", true )
					.turnCost( 1 );
				new Option( 3, "moxie", true )
					.turnCost( 1 );
			}
		};
		...
		new ChoiceAdventure( 191, "Chatterboxing", "The F'c'le" )
		{
			void setup()
			{
				...
				new Option( 2, "with valuable trinket, banish chatty pirate, otherwise lose hp", true )
					.turnCost( 1 )
					.attachItem( ItemPool.VALUABLE_TRINKET, -1, MANUAL, new DisplayAll( "trinket", NEED, AT_LEAST, 1 ) );
				new Option( 3, "muscle substats", true )
					.turnCost( 1 );
				new Option( 4, "mysticality substats", true )
					.turnCost( 1 );
		...
		new ChoiceAdventure( 197, "Somewhat Higher and Mostly Dry", "A Maze of Sewer Tunnels" )
		{
			void setup()
			{
				new Option( 1, "take the tunnel", true )
					.turnCost( 1 );
				new Option( 2, "fight sewer gator", true );
				new Option( 3, "turn the valve", true )
					.turnCost( 1 );
			}
		...
		new ChoiceAdventure( 198, "Disgustin' Junction", "A Maze of Sewer Tunnels" )
		{
			void setup()
			{
				...
				new Option( 3, "open the grate", true )
					.turnCost( 1 );
			}
		...
		new ChoiceAdventure( 199, "The Former or the Ladder", "A Maze of Sewer Tunnels" )
		{
			void setup()
			{
				...
				new Option( 3, "head down the ladder", true )
					.turnCost( 1 );
			}
