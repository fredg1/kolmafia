...
class CADatabase300to399 extends ChoiceAdventureDatabase {
  final void add300to399() {
    ...
    new ChoiceAdventure(305, "There is Sauce at the Bottom of the Ocean", "The Marinara Trench") {
      void setup() {
        new Option(1, "Mer-kin pressureglobe -> Deep Sauce", true)
            .turnCost(1)
            .attachItem(
                ItemPool.MERKIN_PRESSUREGLOBE,
                -1,
                MANUAL,
                new DisplayAll("pressureglobe", NEED, AT_LEAST, 1))
            .attachItem("globe of Deep Sauce", 1, AUTO);
        new Option(2, "skip adventure", true).entersQueue(false);
        new Option(3).attachItem("globe of Deep Sauce", 1, AUTO);
      }
      ...
      void postChoice1(GenericRequest request, int decision) {
        if (decision == 1
            && request.responseText.contains("no safe way of transporting the Deep Sauc")) {
          this.choiceFailed();
        }
      }
    };
    ...
    new ChoiceAdventure(309, "Barback", "The Dive Bar") {
      void setup() {
        new Option(1, null, true).turnCost(1).attachItem("seaode", 1, AUTO);
        new Option(2, "skip adventure", true).entersQueue(false);
      }
    ...
    new ChoiceAdventure(310, "The Economist of Scales", "Madness Reef") {
      ...
      void setup() {
        ...
        new Option(2, "10 rough fish scales -> 1 pristine fish scale", true)
            .attachItem(
                ROUGH_FISH_SCALE.getInstance(-10), MANUAL, new ImageOnly("rough fish scales"))
    ...
    new ChoiceAdventure(313, "Sneaky Intent", "The Mer-Kin Outpost") {
      ...
      void setup() {
        new Option(1, "an error happened").turnCost(1);
        new Option(2, "an error happened").turnCost(1);
        new Option(3, "an error happened").turnCost(1);
        new Option(4, "skip adventure").entersQueue(false);
      }
      ...
      void visitChoice(GenericRequest request) {
        ...
        SeaMerkinOutpostManager.visitOutpostTent(
            this.choice,
            this.options,
            new AdventureResult[] {MERKIN_SNEAKMASK, MERKIN_FASTJUICE, MERKIN_TAKEBAG},
            new DisplayAll[] {
    ...
    new ChoiceAdventure(314, "Aggressive Intent", "The Mer-Kin Outpost") {
      final AdventureResult MERKIN_ROUNDSHIELD =
          new AdventureResult("Mer-kin roundshield", 1, false);
      final AdventureResult MERKIN_BREASTPLATE =
          new AdventureResult("Mer-kin breastplate", 1, false);
      ...
      void visitChoice(GenericRequest request) {
        ...
        SeaMerkinOutpostManager.visitOutpostTent(
            this.choice,
            this.options,
            new AdventureResult[] {MERKIN_ROUNDSHIELD, MERKIN_BREASTPLATE, MERKIN_HOOKSPEAR},
            new DisplayAll[] {
    ...
    new ChoiceAdventure(315, "Mysterious Intent", "The Mer-Kin Outpost") {
      ...
      final AdventureResult MERKIN_PRAYERBEADS =
          new AdventureResult("Mer-kin prayerbeads", 1, false);
      ...
      void visitChoice(GenericRequest request) {
        ...
        SeaMerkinOutpostManager.visitOutpostTent(
            this.choice,
            this.options,
            new AdventureResult[] {MERKIN_KILLSCROLL, MERKIN_HEALSCROLL, MERKIN_PRAYERBEADS},
            new DisplayAll[] {
    ...
    new ChoiceAdventure(330, "A Shark's Chum", "The Haunted Billiards Room") {
      void setup() {
        ...
        new Option(1, "stats and pool skill", true).turnCost(1);
        new Option(2, "fight hustled spectre", true).attachItem("cube of billiard chalk", 1, AUTO);
      }
    ...
    new ChoiceAdventure(337, "Engulfed!", "The Slime Tube") {
      void setup() {
        new Option(1, "+1 rusty -> slime-covered item conversion", true).turnCost(1);
        new Option(2, "raise area ML", true).turnCost(1);
        new Option(3, "skip adventure", true).entersQueue(false);
      }

      @Override
      void postChoice1(GenericRequest request, int decision) {
        // You reach for the uvula, but before you can tickle it, it withdraws into the Slime and
        // out of reach. Ah well.
        // You reach for the gall bladder, but before you can squeeze it, it withdraws into the
        // Slime and out of reach. Ah well.
        // You reach for the uvula, but before you can tickle it, it recoils from you and disappears
        // into the mass of Slime. Looks like the Slime still remembers you from last time.
        // You reach for the gall bladder, but before you can get hold of it, it recoils from you
        // and disappears into the mass of Slime. Looks like the Slime still remembers you from last
        // time.
    ...
    new ChoiceAdventure(349, "The Primordial Directive", "The Primordial Soup") {
      void setup() {
        new Option(1, "unlock the real zone (after using amino acids)", true).turnCost(1);
        new Option(2, "few substats", true).turnCost(1);
      ...
      void postChoice2(GenericRequest request, int decision) {
        ...
        if (decision == 1
            && request.responseText.contains("a brighter and warmer part of the soup")) {
    ...
    new ChoiceAdventure(350, "Soupercharged", "The Primordial Soup") {
      ...
      void visitChoice(GenericRequest request) {
        if (QuestDatabase.isQuestFinished(Quest.PRIMORDIAL)) {
          getOption(1).text("stats").turnCost(1);
        }
      }
    ...
    new ChoiceAdventure(
        352, "Savior Faire", "Seaside Megalopolis") { // also called "Savorier Savior"
      void setup() {
        new Option(1, "moxie substats -> Bad Reception Down Here", true).turnCost(1);
        new Option(2, "muscle substats -> A Diseased Procurer", true).turnCost(1);
        new Option(3, "myst substats -> Give it a Shot", true).turnCost(1);
      }
    };

    new ChoiceAdventure(353, "Bad Reception Down Here", "Seaside Megalopolis") {
      void setup() {
        new Option(1, null, true).turnCost(1).attachItem(ItemPool.INDIGO_PARTY_INVITATION, 1, AUTO);
        new Option(2, null, true).turnCost(1).attachItem(ItemPool.VIOLET_HUNT_INVITATION, 1, AUTO);
      }
    };

    new ChoiceAdventure(
        354, "You Can Never Be Too Rich or Too in the Future", "Seaside Megalopolis") {
      void setup() {
    ...
    new ChoiceAdventure(356, "A Diseased Procurer", "Seaside Megalopolis") {
      void setup() {
        new Option(1, null, true).turnCost(1).attachItem(ItemPool.BLUE_MILK_CLUB_CARD, 1, AUTO);
        new Option(2, null, true).turnCost(1).attachItem(ItemPool.MECHA_MAYHEM_CLUB_CARD, 1, AUTO);
      }
    };
    ...
    new ChoiceAdventure(
        360, "Cavern Entrance", "The Jungles of Ancient Loathing") { // Variable name; Wumpus caves
      void setup() {
    ...
    new ChoiceAdventure(365, "None Shall Pass", "Seaside Megalopolis") {
      void setup() {
        new Option(1, "muscle substats", true).turnCost(1).attachMeat(-30, AUTO);
        new Option(2, null, true)
            .turnCost(1)
            .attachMeat(-60, AUTO)
    ...
    new ChoiceAdventure(368, "City Center", "The Jungles of Ancient Loathing") {
      void setup() {
        new Option(1).leadsTo(369);
        new Option(2).leadsTo(370);
        new Option(3).leadsTo(371);
        new Option(4).leadsTo(372, true);
        new Option(5, "skip adventure").entersQueue(false);
      }
    };

    new ChoiceAdventure(369, "North Side of the City", "The Jungles of Ancient Loathing") {
      void setup() {
        new Option(1).leadsTo(373, true);
        new Option(2).leadsTo(374, true);
        new Option(3).leadsTo(368);
        new Option(4, "skip adventure").entersQueue(false);
      }
    };
    ...
    new ChoiceAdventure(370, "East Side of the City", "The Jungles of Ancient Loathing") {
      void setup() {
        new Option(1).leadsTo(375, true);
        new Option(2).leadsTo(368);
        new Option(3).leadsTo(377);
        new Option(4, "skip adventure").entersQueue(false);
      }
    };
    ...
    new ChoiceAdventure(371, "West Side of the City", "The Jungles of Ancient Loathing") {
      void setup() {
        new Option(1).leadsTo(374, true);
        new Option(2).leadsTo(368);
        new Option(3).leadsTo(378, true);
        new Option(4, "skip adventure").entersQueue(false);
      }
    };
    ...
    new ChoiceAdventure(372, "An Ancient Well", "The Jungles of Ancient Loathing") {
      ...
      void setup() {
        new Option(1).leadsTo(368);
        new Option(2).turnCost(1).attachItem(GRAPPLING_HOOK, AUTO);
        new Option(3);
        new Option(4, "nothing").entersQueue(false);
        new Option(5, "skip adventure").entersQueue(false);
      }
    ...
    new ChoiceAdventure(373, "Northern Gate", "The Jungles of Ancient Loathing") {
      ...
      void setup() {
        ...
        new Option(5);
        new Option(6).leadsTo(376);
        new Option(7, "nothing").entersQueue(false);
        new Option(8, "skip adventure").entersQueue(false);
      }
      ...
      void visitChoice(GenericRequest request) {
        ...
        if (request == null) {
          option.text(
              "once both blocks are in place, allows destroying the weights in the catacombs");
        ...
        if (request == null) {
          option.text("once you destroyed the weights in the catacombs, allows going north");
            ...
            "when the chains holding the counterweights broke")) {
          option.text("allows going north").turnCost(1);
        } else {
          option.text("nothing (yet)").entersQueue(false);
        }
      }
    };
    ...
    new ChoiceAdventure(374, "An Ancient Tower", "The Jungles of Ancient Loathing") {
      ...
      void visitChoice(GenericRequest request) {
        ...
        if (GRAPPLING_HOOK.getCount(KoLConstants.inventory) == 0) {
          option.text("waste an adventure").turnCost(1);
        } else {
    ...
    new ChoiceAdventure(375, "Northern Abandoned Building", "The Jungles of Ancient Loathing") {
      ...
      void setup() {
        new Option(1).leadsTo(370);
        new Option(2);
        new Option(3).leadsTo(379, true);
        new Option(4, "skip adventure").entersQueue(false);
      }
      ...
      void visitChoice(GenericRequest request) {
        ...
        if (IRON_KEY.getCount(KoLConstants.inventory) == 0
          ...
          option.text("get memory of an iron key").turnCost(1).attachItem(IRON_KEY, AUTO);
        } else {
          option.text("nothing").entersQueue(false);
        }
      }
    };
    ...
    new ChoiceAdventure(376, "Ancient Temple", "The Jungles of Ancient Loathing") { // locked
      void setup() {
        new Option(1).leadsTo(373, true);
        new Option(2, "nothing").entersQueue(false);
    ...
    new ChoiceAdventure(377, "Southern Abandoned Building", "The Jungles of Ancient Loathing") {
      void setup() {
        new Option(1).leadsTo(370);
        new Option(2).leadsTo(380, true);
        new Option(3).leadsTo(381);
        new Option(4, "skip adventure").entersQueue(false);
      }
    };
    ...
    new ChoiceAdventure(378, "Storehouse", "The Jungles of Ancient Loathing") {
      void setup() {
        new Option(1).leadsTo(371);
        new Option(2).turnCost(1).attachItem(ItemPool.GRAPPLING_HOOK, 1, AUTO);
        new Option(3, "skip adventure").entersQueue(false);
      }
      ...
      void visitChoice(GenericRequest request) {
        ...
        if (request == null) {
          option
              .text("get grappling hook (first time only)")
              .attachItem(ItemPool.GRAPPLING_HOOK, 1, AUTO);
        } else if (request.responseText.contains(
            "wouldn't set your hopes on finding anything else")) {
          option.text("waste an adventure");
        } else {
          option.text("get grappling hook").attachItem(ItemPool.GRAPPLING_HOOK, 1, AUTO);
        }
      }
    };
    ...
    new ChoiceAdventure(379, "Northern Building (Basement)", "The Jungles of Ancient Loathing") {
      ...
      void visitChoice(GenericRequest request) {
        ...
        if (request == null) {
          option
              .text("fight giant spider, then get small stone block with iron key, then nothing")
    ...
    new ChoiceAdventure(380, "Southern Building (Upstairs)", "The Jungles of Ancient Loathing") {
      void setup() {
        new Option(1).leadsTo(377);
        new Option(2, "fight giant jungle python, then nothing");
        new Option(3).turnCost(1).attachItem(ItemPool.LITTLE_STONE_BLOCK, 1, AUTO);
        new Option(4, "skip adventure").entersQueue(false);
      }
    ...
    new ChoiceAdventure(382, "Catacombs Entrance", "The Jungles of Ancient Loathing") {
      void setup() {
        new Option(1).leadsTo(381);
        new Option(2).leadsTo(383);
        new Option(3, "skip adventure").entersQueue(false);
      }
    };
    ...
    new ChoiceAdventure(383, "Catacombs Junction", "The Jungles of Ancient Loathing") {
      void setup() {
        new Option(1).leadsTo(385, true);
        new Option(2).leadsTo(382);
        new Option(3).leadsTo(384);
        new Option(4, "skip adventure").entersQueue(false);
      }
    };
    ...
    new ChoiceAdventure(384, "Catacombs Dead-End", "The Jungles of Ancient Loathing") {
      void setup() {
        new Option(1).leadsTo(383);
        new Option(2, "smash the chest open").entersQueue(false);
    ...
    new ChoiceAdventure(389, "The Unbearable Supremeness of Being", "Seaside Megalopolis") {
      final AdventureResult SUPREME_BEING_GLOSSARY =
          ItemPool.get(ItemPool.SUPREME_BEING_GLOSSARY, -1);
    ...
    new ChoiceAdventure(393, "The Collector", "Item-Driven") {
      void setup() {
        ...
        new Option(1, "1 of each marble -> 32768 Meat", true).attachMeat(32768, AUTO);
        new Option(2, "skip adventure", true);
    ...
    new ChoiceAdventure(394, "Hellevator Music", "Heartbreaker's Hotel") {
      final Pattern HELLEVATOR_PATTERN =
          Pattern.compile(
    ...
    new ChoiceAdventure(396, "Woolly Scaly Bully", "Mer-kin Elementary School") {
      void setup() {
        ...
        new Option(1, "lose HP", true).turnCost(1);
        new Option(2, "lose HP", true).turnCost(1);
        new Option(3, "unlock janitor's closet", true).turnCost(1);
      }
    };
    ...
    new ChoiceAdventure(397, "Bored of Education", "Mer-kin Elementary School") {
      void setup() {
        ...
        new Option(1, "lose HP", true).turnCost(1);
        new Option(2, "unlock the bathrooms", true).turnCost(1);
        new Option(3, "lose HP", true).turnCost(1);
      }
    };
    ...
    new ChoiceAdventure(398, "A Mer-kin Graffiti", "Mer-kin Elementary School") {
      void setup() {
        ...
        new Option(1, "unlock teacher's lounge", true).turnCost(1);
        new Option(2, "lose HP", true).turnCost(1);
        new Option(3, "lose HP", true).turnCost(1);
      }
    };
    ...
    new ChoiceAdventure(399, "The Case of the Closet", "Mer-kin Elementary School") {
      void setup() {
        ...
        new Option(2, "Mer-kin sawdust", true).turnCost(1).attachItem("Mer-kin sawdust", 1, AUTO);
      }
    };
  }
}
