	...
	final void add200to299()
	{
		...
		new ChoiceAdventure( 206, "Getting Tired", "Burnbarrel Blvd." )
		{
			void setup()
			{
				...
				new Option( 1, "start tirevalanche", true )
					.turnCost( 1 );
				new Option( 2, "add tire to stack", true )
					.turnCost( 1 );
		...
		new ChoiceAdventure( 207, "Hot Dog! I Mean... Door!", "Burnbarrel Blvd." )
		{
			void setup()
			{
				new Option( 1, "add hot hobos & get clan meat", true )
					.turnCost( 1 );
				new Option( 2, "skip adventure", true )
					.entersQueue( false );
			}
		...
		new ChoiceAdventure( 208, "Ah, So That's Where They've All Gone", "The Ancient Hobo Burial Ground" )
		{
			void setup()
			{
				new Option( 1, "increase spooky & decrease stench", true )
					.turnCost( 1 );
				new Option( 2, "skip adventure", true )
					.entersQueue( false );
			}
		...
		new ChoiceAdventure( 211, "Despite All Your Rage", "A Maze of Sewer Tunnels" ) // initial trap
		{
			...
			{
				if ( decision == 1 && !request.responseText.contains( "You gnaw through the bars on the cage" ) )
				{
		...
		new ChoiceAdventure( 212, "Despite All Your Rage", "A Maze of Sewer Tunnels" ) // waiting for rescue -- nothing
		{
			void setup()
			{
				this.isSuperlikely = true;
		...
		new ChoiceAdventure( 213, "Piping Hot", "Burnbarrel Blvd." )
		{
			void setup()
			{
				new Option( 1, "decrease heat & increase sleaze popularity", true )
					.turnCost( 1 );
				new Option( 2, "skip adventure", true )
					.entersQueue( false );
			}
		...
		new ChoiceAdventure( 214, "You vs. The Volcano", "The Heap" )
		{
			void setup()
			{
				new Option( 1, "kill stench hobos & increase stench", true )
					.turnCost( 1 );
				new Option( 2, "skip adventure", true )
					.entersQueue( false );
			}
		...
		new ChoiceAdventure( 215, "Piping Cold", "Exposure Esplanade" )
		{
			void setup()
			{
				new Option( 1, "decrease heat", true )
					.turnCost( 1 );
				new Option( 2, "decrease sleaze popularity", true )
					.turnCost( 1 );
		...
		new ChoiceAdventure( 216, "The Compostal Service", "The Heap" )
		{
			void setup()
			{
				new Option( 1, "decrease stench & spooky", true )
					.turnCost( 1 );
				new Option( 2, "skip adventure", true )
					.entersQueue( false );
			}
		...
		new ChoiceAdventure( 217, "There Goes Fritz!", "Exposure Esplanade" )
		{
			void setup()
			{
				...
				new Option( 1, "use a few icicles to kill cold hobos", true )
					.turnCost( 1 );
				new Option( 2, "use icicles to kill cold hobos, may vow to stop yodeling", true )
					.turnCost( 1 );
		...
		new ChoiceAdventure( 218, "I Refuse!", "The Heap" )
		{
			void setup()
			{
				...
				new Option( 1, "explore the junkpile & reset stench", true )
					.turnCost( 1 );
				new Option( 2, "skip adventure & reset stench", true )
					.entersQueue( false );
			}
		};
		...
		new ChoiceAdventure( 219, "The Furtivity of My City", "The Purple Light District" )
		{
			void setup()
			{
				...
				new Option( 2, "increase stench", true )
					.turnCost( 1 );
				new Option( 3, "add sleaze hobos & get clan meat", true )
					.turnCost( 1 );
			}
		...
		new ChoiceAdventure( 220, "Returning to the Tomb", "The Ancient Hobo Burial Ground" )
		{
			void setup()
			{
				new Option( 1, "add spooky hobos, increase zone ML & get clan meat", true )
					.turnCost( 1 );
				new Option( 2, "skip adventure", true )
					.entersQueue( false );
			}
		...
		new ChoiceAdventure( 221, "A Chiller Night", "The Ancient Hobo Burial Ground" )
		{
			void setup()
			{
				...
				new Option( 1, "study the dance moves", true )
					.turnCost( 1 );
				new Option( 2, "dance (poorly) with hobo zombies", true )
					.turnCost( 1 );
				new Option( 3, "skip adventure (still consumes this instance)", true )
					.entersQueue( false );
			}
		};

		new ChoiceAdventure( 222, "A Chiller Night", "The Ancient Hobo Burial Ground" ) // after watching x3
		{
			void setup()
			{
				this.customName = this.name;

				new Option( 1, "kill spooky hobos", true )
					.turnCost( 1 );
				new Option( 2, "skip adventure (still consumes this instance)", true )
					.entersQueue( false );
			}
		};
		...
		new ChoiceAdventure( 223, "Getting Clubbed", "The Purple Light District" )
		{
			void setup()
			{
				new Option( 1, "get inside (if popularity is low enough)", true )
					.leadsTo( 224 );
				new Option( 2, "decrease sleaze popularity", true )
					.turnCost( 1 );
				new Option( 3, "decrease sleaze popularity & add 5 \"A Chiller Night\" instances in AHBG", true )
					.turnCost( 1 );
			}
		...
		new ChoiceAdventure( 224, "Exclusive!", "The Purple Light District" )
		{
			...
			{
				new Option( 1, "fight sleaze hobo", true );
				new Option( 2, "kill 10% of remaining sleaze hobos", true )
					.turnCost( 1 );
				new Option( 3, "get lots of stats & increase sleaze popularity", true )
					.turnCost( 1 );
			}
		};
		...
		new ChoiceAdventure( 225, "Attention -- A Tent!", "Hobopolis Town Square" )
		{
			void setup()
			{
				new Option( 1, "perform on stage", true )
					.leadsTo( 226 );
				new Option( 2, "join the crowd", true )
					.leadsTo( 227 );
				new Option( 3, "skip adventure", true )
					.entersQueue( false );
			}
			...
			{
				AdventureResult instrument = HobopolisManager.getClassInstrument( KoLCharacter.getClassType() );
				...
				{
					option.attachItem( instrument.getInstance( 0 ), AUTO, new DisplayAll( NEED, EQUIPPED_AT_LEAST, 1 ) );
				}
			}
		...
		{
			final String[] moshResults = new String[] {
				"waste an adventure",
			...
			final String[] buskResults = new String[] {
				"waste an adventure",
				"get ~4 nickels",
				"get ~6 nickels",
				"get ~8 nickels",
			...
			void setup()
			{
				new Option( 1, "click me" )
					.entersQueue( false );
				new Option( 2, "survey the crowd, first" )
					.turnCost( 1 );
				new Option( 3, "survey the crowd, first" )
					.turnCost( 1 );
			...
			void visitChoice( GenericRequest request )
			{
				...
				LinkedList<String> missingPerformers = HobopolisManager.getMissingPerformers();
				...
				// currently nobody on stage. Missing seal clubber, turtle tamer, pastamancer, sauceror, disco bandit, accordion thief.
				...
				{
					surveyText.append( "Missing " + String.join( ", ", missingPerformers ) );

					for ( String KoLClass : missingPerformers )
					{
						getOption( 1 ).attachItem( HobopolisManager.getClassInstrument( KoLClass ).getInstance( 0 ), AUTO, new ImageOnly( KoLClass ) );
					}
				}
		...
		new ChoiceAdventure( 231, "The Hobo Marketplace", "Hobopolis Town Square" ) // decoded
		{
			void setup()
			{
				new Option( 1, "auto-used consumables" )
					.leadsTo( 233 );
				new Option( 2, "buy hobo items" )
					.leadsTo( 245 );
				new Option( 3, "buffs/tattoo" )
					.leadsTo( 262 );
			}
		};
		...
		new ChoiceAdventure( 235, "Food, Glorious Food", "Hobopolis Town Square" ) // decoded
		{
			void setup()
			{
				new Option( 1, "muscle food" )
					.leadsTo( 237, true );
				new Option( 2, "mysticality food" )
					.leadsTo( 238, true );
				new Option( 3, "moxie food" )
					.leadsTo( 239, true );
			}
		};
		...
		new ChoiceAdventure( 240, "Booze, Glorious Booze", "Hobopolis Town Square" ) // decoded
		{
			void setup()
			{
				new Option( 1, "muscle booze" )
					.leadsTo( 242 );
				new Option( 2, "mysticality booze" )
					.leadsTo( 243 );
				new Option( 3, "moxie booze" )
					.leadsTo( 244 );
			}
		};
		...
		new ChoiceAdventure( 245, "Math Is Hard", "Hobopolis Town Square" ) // decoded
		{
			void setup()
			{
				new Option( 1, "hats/pants/accessories" )
					.leadsTo( 248 );
				new Option( 2, "combat items/instruments/hobo monkey/free stats" )
					.leadsTo( 253 );
				new Option( 3 )
					.leadsTo( 247, false, ( Option o ) -> o.index == 1 );
			}
		};
		...
		new ChoiceAdventure( 248, "Garment District", "Hobopolis Town Square" ) // decoded
		{
			...
			{
				new Option( 1 )
					.leadsTo( 250, false, ( Option o ) -> o.index != 4 );
				new Option( 2 )
					.leadsTo( 251, false, ( Option o ) -> o.index != 4 );
				new Option( 3 )
					.leadsTo( 252, false, ( Option o ) -> o.index != 4 );
			}
		};
		...
		new ChoiceAdventure( 253, "Housewares", "Hobopolis Town Square" ) // decoded
		{
			...
			{
				new Option( 1 )
					.leadsTo( 255, false, ( Option o ) -> o.index != 4 );
				new Option( 2, "fight gang of hobo muggers" );
				new Option( 3, "instruments/hobo monkey/free stats" )
					.leadsTo( 256, true );
			}
		};
		...
		new ChoiceAdventure( 256, "Entertainment", "Hobopolis Town Square" ) // decoded
		{
			void setup()
			{
				new Option( 1 );
				new Option( 2 )
					.leadsTo( 259, true, ( Option o ) -> o.index != 3 );
				new Option( 3, "fight gang of hobo muggers" );
			}
			...
			void visitChoice( GenericRequest request )
			{
				...
				Option option = getOption( 1 );
				AdventureResult classInstrument = HobopolisManager.getClassInstrument( KoLCharacter.getClassType() );
				if ( classInstrument.getCount( KoLConstants.inventory ) +
				     ...
				     InventoryManager.getEquippedCount( classInstrument ) > 0 )
				{
		...
		new ChoiceAdventure( 259, "We'll Make Great...", "Hobopolis Town Square" ) // decoded
		{
			...
			{
				new Option( 1 )
					.leadsTo( 261, false, ( Option o ) -> o.index == 1 );
				new Option( 2 )
					.turnCost( 1 );
				new Option( 3, "fight gang of hobo muggers" );
			}
			...
			void visitChoice( GenericRequest request )
			{
				...
				getOption( 2 ).text( "gain " +
					Math.min( KoLCharacter.getBaseMainstat(), 200 ) +
					" of each substats" );
			}
		};
		...
		new ChoiceAdventure( 262, "Salud", "Hobopolis Town Square" ) // decoded
		{
			void setup()
			{
				new Option( 1, "20 adv of Trepandation" )
					.turnCost( 1 )
					.attachEffect( "Trepandation" );
				new Option( 2 )
					.leadsTo( 264, false, ( Option o ) -> o.index != 3, " or " );
				new Option( 3 )
					.leadsTo( 265, false, ( Option o ) -> true, "<br>" );
			}
		};
		...
		new ChoiceAdventure( 265, "Another Part of the Market", "Hobopolis Town Square" ) // decoded
		{
			...
			{
				new Option( 1 )
					.leadsTo( 267, false, ( Option o ) -> o.index != 3, " or " );
				new Option( 2 )
					.leadsTo( 268, false, ( Option o ) -> o.index != 3, " or " );
				new Option( 3 )
					.leadsTo( 269, false, ( Option o ) -> o.index != 2, " or " );
			}
		};
		...
		new ChoiceAdventure( 269, "Body Modifications", "Hobopolis Town Square" ) // decoded
		{
			void setup()
			{
				...
				new Option( 2, "fight gang of hobo muggers" );
				new Option( 3, "20 adv of Hooked Up and restore all MP" )
					.attachEffect( "Hooked Up" );
			}
		};
		...
		new ChoiceAdventure( 273, "The Frigid Air", "Exposure Esplanade" )
		{
			void setup()
			{
				new Option( 1, "frozen banquet", true )
					.turnCost( 1 )
					.attachItem( "frozen banquet", 1, AUTO );
				new Option( 2, "get clan meat", true )
					.turnCost( 1 );
				new Option( 3, "skip adventure", true )
					.entersQueue( false );
			}
			...
			void postChoice1( GenericRequest request, int decision )
			{
				if ( decision == 1 )
				{
					...
					if ( matcher.find() )
					{
						...
						int cost = 20 * tattoo;
						getOption( decision ).attachItem( ItemPool.HOBO_NICKEL, -cost, MANUAL, new DisplayAll( NEED, AT_LEAST, cost ) );
					}
				}
			}
		};
		...
		new ChoiceAdventure( 276, "The Gong Has Been Bung", "Item-Driven" )
		{
			void setup()
			{
				...
				for ( int i = 0; i < GongCommand.GONG_PATHS.length; ++i )
				{
					...
					new CustomOption( index, GongCommand.GONG_PATHS[ index ], () -> {
		...
		new ChoiceAdventure( 297, "Gravy Fairy Ring", "The Haiku Dungeon" )
		{
			void setup()
			{
				...
				new Option( 2, null, true )
					.turnCost( 1 )
					.attachItem( "fairy gravy boat", 1, AUTO );
				new Option( 3, "skip adventure", true )
					.entersQueue( false );
			}
		};
		...
		new ChoiceAdventure( 299, "Down at the Hatch", "The Wreck of the Edgar Fitzsimmons" )
		{
			void setup()
			{
				new Option( 1, "release creatures", true )
					.turnCost( 1 );
				new Option( 2, "skip adventure and banish for 20 adventures", true )
					.entersQueue( false );
