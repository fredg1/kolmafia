...
class CADatabase1200to1299 extends ChoiceAdventureDatabase
{
	final void add1200to1299()
	{
		...
		new ChoiceAdventure( 1202, "Noon in the Civic Center", "Gingerbread Civic Center" )
		{
			void setup()
			{
				...
				new Option( 1 )
					.attachItem( "fancy marzipan briefcase", 1, AUTO, new NoDisplay() );
				...
				new CustomOption( 4, "acquire briefcase full of sprinkles (with gingerbread blackmail photos)" );
			}
		...
		new ChoiceAdventure( 1203, "Midnight in Civic Center", "Gingerbread Civic Center" )
		{
			void setup()
			{
				...
				new Option( 5 )
					...
					.attachItem( ItemPool.GINGERBREAD_DOG_TREAT, -1, MANUAL, new DisplayAll( NEED, AT_LEAST, 1 ) );
		...
		new ChoiceAdventure( 1205, "Midnight at the Train Station", "Gingerbread Train Station" )
		{
			...
			{
				getOption( 1 ).text( Preferences.getInteger( "gingerMuscleChoice" ) +
					" tracks added this ascension" );
			}
		...
		new ChoiceAdventure( 1206, "Noon in the Industrial Zone", "Gingerbread Industrial Zone" )
		{
			void setup()
			{
				...
				new CustomOption( 5, "acquire 400-600 sprinkles (with gingerbread mask, pistol and moneybag)" );
			}
		...
		new ChoiceAdventure( 1207, "Midnight in the Industrial Zone", "Gingerbread Industrial Zone" )
		{
			void setup()
			{
				...
				new Option( 1 )
					.leadsTo( 1212, true, ( Option o ) -> true );
				new Option( 2 )
					.leadsTo( 1213, false, ( Option o ) -> true, " or " );
				new Option( 3 )
					.attachItem( ItemPool.SPRINKLES, -100000, MANUAL );
		...
		new ChoiceAdventure( 1208, "Upscale Noon", "Gingerbread Upscale Retail District" )
		{
			void setup()
			{
				...
				new Option( 7, "acquire 400-600 sprinkles" )
					.attachItem( ItemPool.SPRINKLES, 500, AUTO, new NoDisplay() );
				new Option( 8, "acquire gingerbread blackmail photos (drop off fruit-leather negatives and pick up next visit)", true )
				...
				new CustomOption( 7, "acquire 400-600 sprinkles (with gingerbread mask, pistol and moneybag)" );
		...
		new ChoiceAdventure( 1209, "Upscale Midnight", "Gingerbread Upscale Retail District" )
		{
			void setup()
			{
				...
				new Option( 1 )
					.attachItem( "fake cocktail", 1, AUTO );
				new Option( 2 )
					.leadsTo( 1214 );
		...
		new ChoiceAdventure( 1211, "The Currency Exchange", "Gingerbread Train Station" )
		{
			void setup()
			{
				...
				new Option( 1 )
					.attachMeat( 5000, AUTO );
				new Option( 2 )
					.attachItem( ItemPool.FAT_LOOT_TOKEN, 1, AUTO );
				new Option( 3 )
					.attachItem( ItemPool.SPRINKLES, 250, AUTO );
				new Option( 4 )
					.attachItem( ItemPool.PRICELESS_DIAMOND, 1, AUTO );
				new Option( 5 )
					.attachItem( ItemPool.PRISTINE_FISH_SCALE, 5, AUTO );
		...
		new ChoiceAdventure( 1214, "The Gingerbread Gallery", "Gingerbread Upscale Retail District" )
		{
			void setup()
			{
				...
				new Option( 1 )
					.attachItem( ItemPool.HIGH_END_GINGER_WINE, 1, AUTO );
				new Option( 2 )
		...
		new ChoiceAdventure( 1218, "Wax On", "Item-Driven" )
		{
			...
			void postChoice1( GenericRequest request, int decision )
			{
				if ( decision > 0 && decision < 6 &&
				     !request.responseText.contains( "You acquire an item" ) )
				{
					this.choiceFailed();
				}
			}
		...
		new ChoiceAdventure( 1222, "The Tunnel of L.O.V.E.", "The Tunnel of L.O.V.E." )
		{
			...
			void postChoice2( GenericRequest request, int decision )
			{
				if ( decision == 1 && !request.responseText.contains( "You don't think you are feeling up to a trip through the Tunnel" ) )
				{
		...
		new ChoiceAdventure( 1224, "L.O.V. Equipment Room", "The Tunnel of L.O.V.E." )
		{
			void setup()
			{
				...
				new Option( 1 )
					.attachItem( "LOV Eardigan", 1, AUTO, new NoDisplay() );
				new Option( 2 )
					.attachItem( "LOV Epaulettes", 1, AUTO, new NoDisplay() );
				new Option( 3 )
					.attachItem( "LOV Earrings", 1, AUTO, new NoDisplay() );
				new Option( 4 );
		...
		new ChoiceAdventure( 1228, "L.O.V. Emporium", "The Tunnel of L.O.V.E." )
		{
			void setup()
			{
				...
				new Option( 1 )
					.attachItem( "LOV Enamorang", 1, AUTO, new NoDisplay() );
				new Option( 2 )
					.attachItem( "LOV Emotionizer", 1, AUTO, new NoDisplay() );
				new Option( 3 )
					.attachItem( "LOV Extraterrestrial Chocolate", 1, AUTO, new NoDisplay() );
				new Option( 4 )
					.attachItem( "LOV Echinacea Bouquet", 1, AUTO, new NoDisplay() );
				new Option( 5 )
					.attachItem( "LOV Elephant", 1, AUTO, new NoDisplay() );
				new Option( 6 )
					.attachItem( "toast", 2, AUTO, new NoDisplay() );
				new Option( 7 );
		...
		new ChoiceAdventure( 1231, "Gummi-Memories, In the Corner of Your Mind", "Item-Driven" )
		{
			...
			{
				new Option( 1 )
					.attachItem( ItemPool.GUMMY_MEMORY, -1, MANUAL, new NoDisplay() );
				new Option( 2 );
			}
		...
		{
			final Pattern VACCINE_PATTERN = Pattern.compile( "option value=(\\d+).*?class=button type=submit value=\"([^\"]*)" );
		...
		new ChoiceAdventure( 1237, "A Simple Plant", "Through the Spacegate" )
		{
			void setup()
			{
				...
				new Option( 1, null, true )
					.turnCost( 1 )
					.attachItem( "edible alien plant bit", 1, AUTO );
		...
		new ChoiceAdventure( 1240, "The Animals, The Animals", "Through the Spacegate" )
		{
			void setup()
			{
				...
				new Option( 1, null, true )
					.turnCost( 1 )
					.attachItem( "alien meat", 1, AUTO );
				new Option( 2, "get 1 Research" )
					.turnCost( 1 )
					.attachItem( ItemPool.ALIEN_TOENAILS, 1, AUTO );
				new Option( 3, "get 3 Research" )
					.turnCost( 1 )
		...
		new ChoiceAdventure( 1241, "Buffalo-Like Animal, Won't You Come Out Tonight", "Through the Spacegate" )
		{
			void setup()
			{
				this.customName = this.name;

				new Option( 1, "3 pieces of alien meat", true )
					.turnCost( 1 )
					.attachItem( "alien meat", 3, AUTO );
				new Option( 2, "get 2-3 Research" )
					.turnCost( 1 )
					.attachItem( ItemPool.ALIEN_TOENAILS, 2, AUTO );
				new Option( 3, "get 10 Research" )
					.turnCost( 1 )
		...
		new ChoiceAdventure( 1242, "House-Sized Animal", "Through the Spacegate" )
		{
			void setup()
			{
				...
				new Option( 1, "4 pieces of alien meat", true )
					.turnCost( 1 )
					.attachItem( "alien meat", 4, AUTO );
				new Option( 2, "get 3-4 Research" )
					.turnCost( 1 )
					.attachItem( ItemPool.ALIEN_TOENAILS, 3, AUTO );
				new Option( 3, "get 20 Research" )
					.turnCost( 1 )
		...
		new ChoiceAdventure( 1244, "Here There Be No Spants", "Through the Spacegate" )
		{
			void setup()
			{
				...
				new Option( 1 )
					.turnCost( 1 )
					.attachItem( ItemPool.MURDERBOT_DATA_CORE, 1, AUTO );
			}
		};
		...
		new ChoiceAdventure( 1245, "Recovering the Satellite", "Through the Spacegate" )
		{
			void setup()
			{
				...
				new Option( 1 )
					.turnCost( 1 )
					.attachItem( ItemPool.SPANT_EGG_CASING, 1, AUTO );
			}
		};
		...
		new ChoiceAdventure( 1246, "Land Ho", "Through the Spacegate" )
		{
			void setup()
			{
				...
				new Option( 1, "gain 10% Space Pirate language", true )
					.turnCost( 1 );
				new Option( 6 );
			...
			void visitChoice( GenericRequest request )
			{
				getOption( 1 ).text( "gain 10% Space Pirate language (currently " +
		...
		new ChoiceAdventure( 1247, "Half The Ship it Used to Be", "Through the Spacegate" )
		{
			void setup()
			{
				...
				new Option( 1, "with enough Space Pirate language, get space pirate treasure map, otherwise get +5% Space Pirate language", true )
					.turnCost( 1 )
			...
			void visitChoice( GenericRequest request )
			{
				getOption( 1 ).text( "with enough Space Pirate language, get space pirate treasure map, otherwise get +5% Space Pirate language (currently " +
					Preferences.getInteger( "spacePirateLanguageFluency" ) + "%)" );
			}
		...
		new ChoiceAdventure( 1248, "Paradise Under a Strange Sun", "Through the Spacegate" )
		{
			void setup()
			{
				...
				new Option( 1, "acquire Space Pirate Astrogation Handbook (with space pirate treasure map)", true )
					.turnCost( 1 )
				...
				new Option( 2, "gain 1000 moxie stats", true )
					.turnCost( 1 );
				new Option( 6 );
		...
		new ChoiceAdventure( 1249, "That's No Moonlith, it's a Monolith", "Through the Spacegate" )
		{
			...
			void visitChoice( GenericRequest request )
			{
				getOption( 1 ).text( "gain 20% procrastinator language (with murderbot data core) (currently " +
			...
			void postChoice2( GenericRequest request, int decision )
			{
				if ( decision == 1 )
				{
					SpacegateManager.parseLanguageFluency( request.responseText, "procrastinatorLanguageFluency" );
				}
			}
		};
		...
		new ChoiceAdventure( 1250, "I'm Afraid It's Terminal", "Through the Spacegate" )
		{
			void setup()
			{
				...
				new Option( 1, "acquire procrastinator locker key (with enough procrastinator language)", true )
					.turnCost( 1 )
			...
			void visitChoice( GenericRequest request )
			{
				getOption( 1 ).text( "acquire procrastinator locker key (with enough procrastinator language) (currently " +
					Preferences.getInteger( "procrastinatorLanguageFluency" ) + "%)" );
			}
		...
		new ChoiceAdventure( 1253, "Mother May I", "Through the Spacegate" )
		{
			...
			void visitChoice( GenericRequest request )
			{
				getOption( 1 ).text( "acquire Space Baby bawbaw (with enough Space Baby language) (currently " +
		...
		new ChoiceAdventure( 1260, "A Strange Panel", "Super Villain's Lair" )
		{
			...
			void postChoice2( GenericRequest request, int decision )
			{
				...
				if ( request.responseText.contains( "10 casualties" ) || request.responseText.contains( "10 crew" ) ||
				     request.responseText.contains( "10 minions" ) || request.responseText.contains( "10 ski" ) ||
				     request.responseText.contains( "10 members" ) || request.responseText.contains( "ten techs" ) ||
				     request.responseText.contains( "10 soldiers" ) )
				{
					Preferences.increment( "_villainLairProgress", 10 );
				}
				else if ( request.responseText.contains( "5 casualties" ) || request.responseText.contains( "5 souls" ) ||
				          request.responseText.contains( "5 minions" ) || request.responseText.contains( "five minions" ) ||
				          request.responseText.contains( "group of ski" ) || request.responseText.contains( "5 members" ) ||
				          request.responseText.contains( "five people" ) || request.responseText.contains( "five of us" ) )
				{
		...
		new ChoiceAdventure( 1261, "Which Door?", "Super Villain's Lair" )
		{
			...
			void visitChoice( GenericRequest request )
			{
				...
				{
					option.attachItem( ItemPool.SNEAKY_PETE_KEY, -1, MANUAL, new DisplayAll( NEED, AT_LEAST, 1 ) );
		...
		new ChoiceAdventure( 1262, "What Setting?", "Super Villain's Lair" )
		{
			...
			void postChoice2( GenericRequest request, int decision )
			{
				...
				if ( request.responseText.contains( "20 of the" ) || request.responseText.contains( "20 minions" ) ||
				     request.responseText.contains( "20 or so" ) || request.responseText.contains( "20 soldiers" ) )
				{
					Preferences.increment( "_villainLairProgress", 20 );
				}
				else if ( request.responseText.contains( "10 or so" ) || request.responseText.contains( "10 injured" ) ||
				          request.responseText.contains( "10 patrol-sicles" ) || request.responseText.contains( "10 soldiers" ) )
				{
					Preferences.increment( "_villainLairProgress", 10 );
				}
				else if ( request.responseText.contains( "15 aquanats" ) || request.responseText.contains( "15 reserve" ) ||
				          request.responseText.contains( "15 previously" ) || request.responseText.contains( "15 Soldiers" ) )
				{
		...
		{
			final Pattern HORSE_NAME_PATTERN = Pattern.compile( "<td valign=top class=small><b>([^<]+)</b> the ([^ ]+) Horse<P>" );
			final Pattern CRAZY_HORSE_MODIFIERS_PATTERN = Pattern.compile( "Gives you\\s+([+-]\\d+)% Muscle, ([+-]\\d+)% Mysticality, and ([+-]\\d+)%" );
			...
			void visitChoice( GenericRequest request )
			{
				...
				Preferences.setString( "_horsery",
					!request.responseText.contains( "name=option value=1" ) ? "normal horse" :
					!request.responseText.contains( "name=option value=2" ) ? "dark horse" :
					!request.responseText.contains( "name=option value=3" ) ? "crazy horse" :
					!request.responseText.contains( "name=option value=4" ) ? "pale horse" :
					"" );
			}
		...
		new ChoiceAdventure( 1273, "The Cursed Warehouse", "Item-Driven" )
		{
			...
			void postChoice1( GenericRequest request, int decision )
			{
				if ( decision == 1 && !request.responseText.contains( "slide the weird key into the weird lock" ) )
				{
					this.choiceFailed();
				}
			}
		...
		new ChoiceAdventure( 1275, "Rummaging through the Garbage", "Item-Driven" )
		{
			...
			final Pattern GARBAGE_SHIRT_PATTERN = Pattern.compile( "Looks like you can read roughly (\\d+) scrap" );
		...
		new ChoiceAdventure( 1281, "You'll See You at the Crossroads", "The Bandit Crossroads" )
		{
			void setup()
			{
				new Option( 1, "unlock The Towering Mountains", true )
					.turnCost( 1 );
				new Option( 2, "unlock The Mystic Wood", true )
					.turnCost( 1 );
				new Option( 3, "unlock The Putrid Swamp", true )
					.turnCost( 1 );
				new Option( 4, "unlock Cursed Village", true )
					.turnCost( 1 );
				new Option( 5, "unlock The Sprawling Cemetery", true )
					.turnCost( 1 );
		...
		new ChoiceAdventure( 1282, "Out of Range", "The Towering Mountains" )
		{
			void setup()
			{
				...
				new Option( 2, "unlock The Foreboding Cave", true )
					.turnCost( 1 );
				new Option( 3, "unlock The Master Thief's Chalet" )
					.turnCost( 1 );
				...
				new Option( 5, "unlock The Ogre Chieftain's Keep" )
					.turnCost( 1 );
				new Option( 10 );
				new Option( 11 );
		...
		new ChoiceAdventure( 1283, "Where Wood You Like to Go", "The Mystic Wood" )
		{
			void setup()
			{
				new Option( 1, "unlock The Faerie Cyrkle", true )
					.turnCost( 1 );
				new Option( 2, "unlock The Druidic Campsite" )
					.turnCost( 1 );
				new Option( 3, "unlock The Ley Nexus" )
					.turnCost( 1 );
		...
		new ChoiceAdventure( 1284, "Swamped with Leisure", "The Putrid Swamp" )
		{
			void setup()
			{
				new Option( 1, "unlock Near the Witch's House", true )
					.turnCost( 1 );
				new Option( 2, "unlock The Troll Fortress (using FantasyRealm key)", true )
					.turnCost( 1 )
					.attachItem( ItemPool.FR_KEY, -1, MANUAL, new DisplayAll( NEED, AT_LEAST, 1 ) );
				new Option( 3, "unlock The Dragon's Moor" )
					.turnCost( 1 );
		...
		new ChoiceAdventure( 1285, "It Takes a Cursed Village", "The Cursed Village" )
		{
			void setup()
			{
				new Option( 1, "unlock The Evil Cathedral", true )
					.turnCost( 1 );
				new Option( 2, "unlock The Cursed Village Thieves' Guild" )
					.turnCost( 1 );
				new Option( 3, "unlock The Archwizard's Tower" )
					.turnCost( 1 );
				new Option( 4, "20 adv of Fortunate, Son" )
					.turnCost( 1 )
					.attachEffect( "Fortunate, Son" );
				...
				new CustomOption( 2, "unlock The Cursed Village Thieves' Guild (using FantasyRealm Rogue's Mask)" );
		...
		new ChoiceAdventure( 1286, "Resting in Peace", "The Sprawling Cemetery" )
		{
			void setup()
			{
				new Option( 1, "unlock The Labyrinthine Crypt", true )
					.turnCost( 1 );
				new Option( 2, "unlock The Barrow Mounds", true )
					.turnCost( 1 );
				new Option( 3, "unlock Duke Vampire's Chateau" )
					.turnCost( 1 );
		...
		new ChoiceAdventure( 1288, "What's Yours is Yours", "The Old Rubee Mine" )
		{
			void setup()
			{
				...
				new Option( 3, "acquire grolblin rum", true )
					.turnCost( 1 )
					.attachItem( "grolblin rum", 1, AUTO );
				new Option( 6 );
		...
		new ChoiceAdventure( 1289, "A Warm Place", "The Foreboding Cave" )
		{
			void setup()
			{
				...
				new Option( 3, "unlock The Lair of the Phoenix" )
					.turnCost( 1 );
				new Option( 6 );
		...
		new ChoiceAdventure( 1290, "The Cyrkle Is Compleat", "The Faerie Cyrkle" )
		{
			void setup()
			{
				...
				new Option( 2, "acquire faerie dust", true )
					.turnCost( 1 )
					.attachItem( "faerie dust", 1, AUTO );
				new Option( 3, "The Spider Queen's Lair" )
					.turnCost( 1 );
				new Option( 6 );
		...
		new ChoiceAdventure( 1292, "Witch One You Want?", "Near the Witch's House" )
		{
			void setup()
			{
				new Option( 1, "50 adv of Brewed up" )
					.turnCost( 1 )
					.attachEffect( "Brewed up" );
				...
				new Option( 3, "acquire to-go brew", true )
					.turnCost( 1 )
					.attachItem( "to-go brew", 1, AUTO );
		...
		new ChoiceAdventure( 1294, "Neither a Barrower Nor a Lender Be", "The Barrow Mounds" )
		{
			void setup()
			{
				...
				new Option( 3, "unlock The Ghoul King's Catacomb" )
					.turnCost( 1 );
				new Option( 6 );
		...
		new ChoiceAdventure( 1296, "For Whom the Bell Trolls", "The Troll Fortress" )
		{
			void setup()
			{
				...
				new Option( 2, "acquire nasty haunch", true )
					.turnCost( 1 )
					.attachItem( "nasty haunch", 1, AUTO );
				...
				new CustomOption( 3, "acquire Cheswick Copperbottom's compass (with Chewsick Copperbottom's notes)" );
		...
		new ChoiceAdventure( 1297, "Stick to the Crypt", "The Labyrinthine Crypt" )
		{
			void setup()
			{
				new Option( 1, "acquire hero's skull", true )
					.turnCost( 1 )
					.attachItem( "hero's skull", 1, AUTO );
		...
		new ChoiceAdventure( 1299, "Stop Dragon Your Feet", "The Dragon's Moor" )
		{
			void setup()
			{
				...
				new CustomOption( 1, "fight Sewage Treatment Dragon (with 5+ stench res and dragon slaying sword)" );
			}
	...
	static final String fantasyRealmBigRedButtonSpoiler()
	{
		...
		for ( String area : new String[] { "The Towering Mountains", "The Mystic Wood", "The Putrid Swamp", "The Cursed Village", "The Sprawling Cemetery" } )
		{
