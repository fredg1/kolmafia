...
class CADatabase400to499 extends ChoiceAdventureDatabase {
  final void add400to499() {
    ...
    new ChoiceAdventure(403, "Picking Sides", "The Skate Park") {
      void setup() {
        new Option(1, null, true).turnCost(1).attachItem("skate blade", 1, AUTO);
        new Option(2, null, true).turnCost(1).attachItem("brand new key", 1, AUTO);
      }
    };
    ...
    new ChoiceAdventure(409, "The Island Barracks", "The Island Barracks") {
      void setup() {
        new Option(1).leadsTo(410);
      }
    };

    new ChoiceAdventure(410, "A Short Hallway", "The Island Barracks") {
      void setup() {
        new Option(1).leadsTo(411);
        new Option(2).leadsTo(412);
        new Option(3, "leave barrack (1)").turnCost(1);
      }
    ...
    new ChoiceAdventure(418, "Parlour", "The Island Barracks") {
      ...
      void postChoice1(GenericRequest request, int decision) {
        ...
        if (decision < 4
            && !request.responseText.contains("Fight!")
    ...
    new RetiredChoiceAdventure(
        426, "It's Electric, Boogie-oogie-oogie", "Crimbo Town Toy Factory (2009)") {
      void setup() {
        new Option(1);
      }
    };
    ...
    new RetiredChoiceAdventure(
        427, "A Voice Crying in the Crimbo Factory", "Crimbo Town Toy Factory (2009)") {
      void setup() {
        new Option(1);
      }
    };
    ...
    new ChoiceAdventure(438, "From Little Acorns...", "The Arrrboretum") {
      void setup() {
        new Option(1).attachItem(ItemPool.UNDERWORLD_ACORN, -1, MANUAL, new ImageOnly());
      }
    };
    ...
    new ChoiceAdventure(441, "The Mad Tea Party", null) {
      ...
      void postChoice2(GenericRequest request, int decision) {
        ...
        if (decision == 1 && !request.responseText.contains("very strict dress code")) {
    ...
    new ChoiceAdventure(442, "A Moment of Reflection", "Item-Driven") {
      void setup() {
        ...
        new Option(1).attachItem(ItemPool.REFLECTION_OF_MAP, -1, MANUAL, new NoDisplay());
        new Option(2).attachItem(ItemPool.REFLECTION_OF_MAP, -1, MANUAL, new NoDisplay());
        new Option(3).attachItem(ItemPool.REFLECTION_OF_MAP, -1, MANUAL, new NoDisplay());
      ...
      void visitChoice(GenericRequest request) {
        ...
        for (int item :
            new int[] {
              ItemPool.BEAUTIFUL_SOUP,
              ItemPool.LOBSTER_QUA_GRILL,
              ItemPool.MISSING_WINE,
              ItemPool.WALRUS_ICE_CREAM,
              ItemPool.HUMPTY_DUMPLINGS
            }) {
        ...
        getOption(4)
            .text("you have " + count + "/5 of the items needed for an ittah bittah hookah");
      }
    ...
    new ChoiceAdventure(445, "The Field of Strawberries", "Item-Driven") { // Pastamancer
      void setup() {
        ...
        new Option(1, "eggman noodles", true).turnCost(1).attachItem("eggman noodles", 1, AUTO);
        new Option(2, "yellow matter custard", true)
            .turnCost(1)
            .attachItem("yellow matter custard", 1, AUTO);
      }
    ...
    new ChoiceAdventure(446, "The Caucus Racetrack", "Item-Driven") { // Accordion Thief
      void setup() {
        ...
        new Option(1, "missing wine", true).turnCost(1).attachItem(ItemPool.MISSING_WINE, 1, AUTO);
    ...
    new ChoiceAdventure(451, "Typographical Clutter", "The Enormous Greater-Than Sign") {
      ...
      void setup() {
        new Option(1, null, true).turnCost(1).attachItem("left parenthesis", 1, AUTO);
        new Option(2, "moxie, alternately lose then gain meat", true).turnCost(1);
        new Option(3).turnCost(1);
        new Option(4, "mysticality substats + MP", true).turnCost(1);
    ...
    new ChoiceAdventure(
        452, "Leave a Message and I'll Call You Back", "Professor Jacking's Small-O-Fier") {
      void setup() {
        new Option(1).turnCost(1);
        new Option(2, "tiny fly glasses", true)
            .turnCost(1)
            .attachItem(ItemPool.TINY_FLY_GLASSES, 1, AUTO);
        new Option(3, "fruit", true).turnCost(1);
    ...
    new ChoiceAdventure(453, "Getting a Leg Up", "Professor Jacking's Small-O-Fier") {
      void setup() {
        ...
        new Option(2, "stats", true).turnCost(1);
        new Option(3, "hair of the calf", true).turnCost(1).attachItem("hair of the calf", 1, AUTO);
      }
    };

    new ChoiceAdventure(
        454, "Just Like the Ocean Under the Moon", "Professor Jacking's Small-O-Fier") {
      void setup() {
        new Option(1, "fight smooth jazz scabie", true);
        new Option(2, "HP and MP", true).turnCost(1).attachMP(95);
      }
    };
    ...
    new ChoiceAdventure(
        456, "Made it, Ma!	 Top of the World!", "Professor Jacking's Huge-A-Ma-tron") {
      void setup() {
        ...
        new Option(3, "a dance upon the palate, or skip adventure", true)
            .turnCost(1)
            .attachItem(
                "a dance upon the palate", 1, AUTO, new DisplayAll("palate", WANT, EXACTLY, 0));
        new Option(4, "stats", true).turnCost(1);
      }

      @Override
      void postChoice1(GenericRequest request, int decision) {
        if (decision == 3
            && request.responseText.contains("You're already tasting too many things")) {
          this.choiceFailed();
        }
      }
    };
    ...
    new ChoiceAdventure(457, "Oh, No! Five-Oh!", "Kegger in the Woods") {
      ...
      void postChoice1(GenericRequest request, int decision) {
        ...
        if (decision == 1 && count > 0) {
          getOption(decision)
              .attachItem(ItemPool.ORQUETTES_PHONE_NUMBER, -count, MANUAL)
