  ...
  final void add600to699() {
    new ChoiceAdventure(600, "Summon Minion", null) {
      ...
      void visitChoice(GenericRequest request) {
        if (KoLCharacter.hasSkill("Summon Horde")) {
          getOption(1)
              .text("also get quantity * 10 adv of Waking the Dead")
    ...
    new ChoiceAdventure(601, "Summon Horde", null) {
      void setup() {
        ...
        new Option(1).attachMeat(-1000, MANUAL);
        new Option(2);
      }
    ...
    new ChoiceAdventure(606, "Lost in the Great Overlook Lodge", "Twin Peak") {
      void setup() {
        new Option(1).leadsTo(607);
        new Option(2).leadsTo(608);
        new Option(3)
            .leadsTo(609)
            .attachItem(ItemPool.JAR_OF_OIL, new DisplayAll(NEED, AT_LEAST, 1));
        new Option(4).leadsTo(610);
        new Option(6, "flee").entersQueue(false);
      }
    ...
    new ChoiceAdventure(610, "To Catch a Killer", "Twin Peak") {
      ...
      void postChoice1(GenericRequest request, int decision) {
        if (decision == 1 && request.responseText.contains("You're starting to pant")) {
          getOption(decision).turnCost(1).entersQueue(true);
        }
      }
    };
    ...
    new ChoiceAdventure(616, "He Is the Arm, and He Sounds Like This", "Twin Peak") {
      void setup() {
        new Option(1).turnCost(1).attachItem(ItemPool.JAR_OF_OIL, -1, MANUAL);
      }
    ...
    new ChoiceAdventure(627, "ChibiBuddy&trade;", "Item-Driven") { // on
      void setup() {
        ...
        new Option(1).leadsTo(628);
        new Option(2).leadsTo(629);
        new Option(3).leadsTo(630);
        new Option(4).leadsTo(631);
        new Option(5).attachEffect("ChibiChanged");
        new Option(6);
        new Option(7);
      }
    };
    ...
    new ChoiceAdventure(630, "Interacting with your ChibiBuddy&trade;", "Item-Driven") {
      void setup() {
        new Option(1, "+Socialization").turnCost(1);
        new Option(2, "-Alignment").turnCost(1);
    ...
    new ChoiceAdventure(631, "Exploring with your ChibiBuddy&trade;", "Item-Driven") {
      void setup() {
        new Option(1, "+Alignment").turnCost(1);
        new Option(2, "-Fitness").turnCost(1);
    ...
    new ChoiceAdventure(636, "First Mate's Log", "The Old Man's Bathtime Adventures") { // set 1
      void setup() {
        new Option(1, "-1 Crayon, Add Cray-Kin").turnCost(1);
        new Option(2, "+3 crew, -8-10 bubbles").turnCost(1);
        new Option(3, "+2 crayons, +8-11 bubbles").turnCost(1);
        new Option(4, "Block Ferocious roc, -2 crayons").turnCost(1);
      }
    };

    new ChoiceAdventure(637, "First Mate's Log", "The Old Man's Bathtime Adventures") { // set 2
      void setup() {
        new Option(1, "Add Bristled Man-O-War").turnCost(1);
        new Option(2, "Block Deadly Hydra, -3 crayons").turnCost(1);
        new Option(3, "+20-23 bubbles, -1 crew").turnCost(1);
        new Option(4, "Block giant man-eating shark, -16 bubbles").turnCost(1);
      }
    };

    new ChoiceAdventure(638, "First Mate's Log", "The Old Man's Bathtime Adventures") { // set 3
      void setup() {
        new Option(1, "Add Deadly Hydra").turnCost(1);
        new Option(2, "+13-19 bubbles").turnCost(1);
        new Option(3, "+4 crayon, -1 crew").turnCost(1);
        new Option(4, "Block fearsome giant squid, -13-20 bubbles").turnCost(1);
      }
    };

    new ChoiceAdventure(639, "First Mate's Log", "The Old Man's Bathtime Adventures") { // set 4
      void setup() {
        new Option(1, "-8 crew, -3 crayons, -17 bubbles, increase NC rate").turnCost(1);
        new Option(2, "+3 crayons").turnCost(1);
        new Option(3, "+3 crayons, +16 bubbles, -2 crew").turnCost(1);
        new Option(4, "+5 crew, -6-16 bubbles, -2 crayons").turnCost(1);
      }
    };
    ...
    new ChoiceAdventure(641, "Stupid Pipes.", "Anger Man's Level") {
      void setup() {
        new Option(1).turnCost(1);
        new Option(2, "flickering pixel").turnCost(1).attachItem("flickering pixel", 1, AUTO);
      ...
      void visitChoice(GenericRequest request) {
        ...
        getOption(1)
            .text(
                "take "
                    + damage
                    + " spooky damage, current HP = "
                    + hp
                    + ", current spooky resistance = "
                    + resistance);
      }
    ...
    new ChoiceAdventure(647, "A Stupid Dummy. Also, a Straw Man.", "Doubt Man's Level") {
      ...
      void visitChoice(GenericRequest request) {
        ...
        getOption(1)
            .text(
                "100 weapon damage required, have "
                    + String.valueOf(KoLCharacter.currentBonusDamage()));
      }
    ...
    new ChoiceAdventure(648, "Slings and Arrows", "Doubt Man's Level") {
      ...
      void visitChoice(GenericRequest request) {
        ...
        if (!request.responseText.contains("Arrows?  Ha.") && KoLCharacter.getCurrentHP() >= 1000) {
    ...
    new ChoiceAdventure(
        650, "This Is Your Life. Your Horrible, Horrible Life.", "Regret Man's Level") {
      void setup() {
        new Option(1).turnCost(1);
        new Option(2, "flickering pixel").turnCost(1).attachItem("flickering pixel", 1, AUTO);
        new Option(3, "skip adventure").entersQueue(false);
    ...
    new ChoiceAdventure(651, "The Wall of Wailing", "Regret Man's Level") {
      ...
      void visitChoice(GenericRequest request) {
        ...
        getOption(1)
            .text("10 prismatic damage required, have " + KoLCharacter.currentPrismaticDamage());
      }
    ...
    new ChoiceAdventure(657, "You Grind 16 Rats, and Whaddya Get?", "Chinatown Tenement") {
      ...
      void postChoice1(GenericRequest request, int decision) {
        if (decision == 1
            && request.responseText.contains("Grumbling, I turned and stomped away")) {
          this.choiceFailed();
        }
      }
    };
    ...
    new ChoiceAdventure(664, "The Crackpot Mystic's Shed", null) {
      void setup() {
        ...
        new Option(1).attachItem(ItemPool.TRANSFUNCTIONER, 1, AUTO);
        new Option(2);
      }
    };
    ...
    new ChoiceAdventure(
        669, "The Fast and the Furry-ous", "The Castle in the Clouds in the Sky (Basement)") {
      ...
      void setup() {
        ...
        new Option(2, "200 Moxie substats", true).turnCost(1);
      ...
      void visitChoice(GenericRequest request) {
        ...
        if (QuestDatabase.isQuestBefore(Quest.GARBAGE, "step8")) {
          option.attachItem(
              TITANIUM_UMBRELLA, new DisplayAll("umbrella", WANT, EQUIPPED_AT_LEAST, 1));
          ...
          option.text("Neckbeard Choice").leadsTo(671, true);
        }
      }
      ...
      void postChoice2(GenericRequest request, int decision) {
        ...
        if (request.responseText.contains("New Area Unlocked")
            && request.responseText.contains("The Ground Floor")) {
    ...
    new ChoiceAdventure(
        670, "You Don't Mess Around with Gym", "The Castle in the Clouds in the Sky (Basement)") {
      ...
      void setup() {
        ...
        new Option(2, "200 Muscle substats", true).turnCost(1);
      ...
      @Override
      void postChoice1(GenericRequest request, int decision) {
        // You take it, trying to shake off the feeling you've just stolen the giant's lost tongue
        // piercing.
    ...
    new ChoiceAdventure(
        671, "Out in the Open Source", "The Castle in the Clouds in the Sky (Basement)") {
      ...
      void setup() {
        ...
        new Option(2, "200 Mysticality substats", true).turnCost(1);
        ...
        new Option(4, "Fitness Choice", true).leadsTo(670, true);
      }
    ...
    new ChoiceAdventure(
      ...
      void setup() {
        ...
        new Option(1, "3 random items", true).turnCost(1);
    ...
    new ChoiceAdventure(
        673, "Putting Off Is Off-Putting", "The Castle in the Clouds in the Sky (Ground Floor)") {
      void setup() {
        ...
        new Option(2, "30 adv of Trash-Wrapped", true).turnCost(1).attachEffect("Trash-Wrapped");
        new Option(3, "skip adventure", true).entersQueue(false);
      }
    ...
    new ChoiceAdventure(
      ...
      final AdventureResult DRUM_N_BASS =
          new AdventureResult("drum 'n' bass 'n' drum 'n' bass record", -1, false);
      ...
      void setup() {
        ...
        new Option(4, "Steampunk Choice", true).leadsTo(677, true);

        new CustomOption(
            5, "with drum'n'bass record, complete quest, otherwise fight goth giant", 2);
        new CustomOption(6, "with drum'n'bass record, complete quest, otherwise candles", 5);
        new CustomOption(
            7, "with drum'n'bass record, complete quest, otherwise Steampunk Choice", 6);
      }
      ...
      String getDecision(String responseText, String decision, int stepCount) {
        boolean canComplete =
            DRUM_N_BASS.getCount(KoLConstants.inventory) > 0
                && QuestDatabase.isQuestBefore(Quest.GARBAGE, "step10");
    ...
    new ChoiceAdventure(677, "Copper Feel", "The Castle in the Clouds in the Sky (Top Floor)") {
      ...
      void setup() {
        ...
        new Option(3, null, true).turnCost(1).attachItem("brass gear", 1, AUTO);
        new Option(4, "Goth Choice", true).leadsTo(675, true);
      }
      ...
      void visitChoice(GenericRequest request) {
        ...
        if (questNotFinished) {
          if (haveAirship) {
            option.leadsTo(679).attachItem(MODEL_AIRSHIP, MANUAL, new DisplayAll("airship"));
          } else {
          ...
          if (haveAirship) {
            ...
            option.turnCost(1).attachItem(MODEL_AIRSHIP, MANUAL, new DisplayAll(NEED, EXACTLY, 0));
          } else {
    ...
    new ChoiceAdventure(
      ...
      void setup() {
        ...
        new Option(2, "500 meat", true).turnCost(1).attachMeat(500, AUTO);
        new Option(3, "Steampunk Choice", true).leadsTo(677, true);
        new Option(4, "Raver Choice", true).leadsTo(676);
      }
    ...
    new ChoiceAdventure(
        680, "Are you a Man or a Mouse?", "The Castle in the Clouds in the Sky (Top Floor)") {
      void setup() {
        this.isSuperlikely = true;

        new Option(1).leadsTo(679);
      }
    };
    ...
    new ChoiceAdventure(690, "The First Chest Isn't the Deepest.", "The Daily Dungeon") {
      void setup() {
        ...
        new Option(1, "Get item", true).turnCost(1);
    ...
    new ChoiceAdventure(692, "I Wanna Be a Door", "The Daily Dungeon") {
      ...
      void setup() {
        ...
        new Option(1, "suffer trap effects", true).turnCost(1);
        ...
        new Option(8, "leave, no turn spent").entersQueue(false);
    ...
    new ChoiceAdventure(693, "It's Almost Certainly a Trap", "The Daily Dungeon") {
      ...
      void setup() {
        ...
        new Option(1, "Suffer elemental damage, get stats", true).turnCost(1);
