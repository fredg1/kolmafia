	...
	final void add1100to1199()
	{
		new ChoiceAdventure( 1100, "Pray to the Barrel God", null )
		{
			void setup()
			{
				...
				new Option( 1 )
					.attachItem( ItemPool.BARREL_LID, 1, AUTO, new NoDisplay() );
				new Option( 2 )
					.attachItem( ItemPool.BARREL_HOOP_EARRING, 1, AUTO, new NoDisplay() );
				new Option( 3 )
					.attachItem( ItemPool.BANKRUPTCY_BARREL, 1, AUTO, new NoDisplay() );
				new Option( 4 );
				new Option( 5 );
				new Option( 6 );
			}
		...
		new ChoiceAdventure( 1106, "Wooof! Wooooooof!", "undefined" )
		{
			void setup()
			{
				...
				new Option( 3, "acquire familiar food", true )
					.attachItem( ItemPool.GHOST_DOG_CHOW, 1, AUTO );
		...
		new ChoiceAdventure( 1107, "Playing Fetch*", "undefined" )
		{
			void setup()
			{
				...
				new Option( 1, "acquire tennis ball", true )
					.attachItem( ItemPool.TENNIS_BALL, 1, AUTO );
				new Option( 2, "30 adv of Tennis Elbow-wow" )
					.attachEffect( "Tennis Elbow-wow" );
				new Option( 3, "acquire ~500 meat", true )
					.attachMeat( 500, AUTO );
		...
		new ChoiceAdventure( 1110, "Spoopy", "Item-Driven" )
		{
			...
			void visitChoice( GenericRequest request )
			{
				if ( request != null )
				{
					Preferences.setBoolean( "doghouseBoarded", !request.responseText.contains( "Board up the doghouse" ) );
				}
			}
		...
		new ChoiceAdventure( 1115, "VYKEA!", "VYKEA" )
		{
			void setup()
			{
				...
				new Option( 3, "fill bucket by 10-15%", true )
					.turnCost( 1 );
			...
			void postChoice2( GenericRequest request, int decision )
			{
				...
				{
					Matcher WalfordMatcher = CADatabase1100to1199.WALFORD_PATTERN.matcher( request.responseText );
		...
		new ChoiceAdventure( 1116, "All They Got Inside is Vacancy (and Ice)", "The Ice Hotel" )
		{
			void setup()
			{
				...
				new Option( 3, "fill bucket by 10-15%", true )
					.turnCost( 1 );
				new Option( 4, "acquire cocktail ingredients", true )
					.turnCost( 1 );
		...
		new ChoiceAdventure( 1119, "Shining Mauve Backwards In Time", "The Deep Machine Tunnels" ) // actually has a random name
		{
			void setup()
			{
				...
				new Option( 4, "duplicate one food, booze, spleen or potion", true )
					.leadsTo( 1125 );
			...
			void postChoice2( GenericRequest request, int decision )
			{
				...
				if ( decision == 4 && Preferences.getInteger( "lastDMTDuplication" ) != KoLCharacter.getAscensions())
				{
		...
		new ChoiceAdventure( 1121, "Some Assembly Required", "Item-Driven" ) // Runes
		{
			...
			{
				new Option( 1 )
					.attachItem( ItemPool.VYKEA_FRENZY_RUNE, -1, MANUAL );
				new Option( 2 )
					.attachItem( ItemPool.VYKEA_BLOOD_RUNE, -1, MANUAL );
				new Option( 3 )
					.attachItem( ItemPool.VYKEA_LIGHTNING_RUNE, -1, MANUAL );
				new Option( 6 );
			}
		...
		new ChoiceAdventure( 1122, "Some Assembly Required", "Item-Driven" ) // Dowels
		{
			...
			{
				new Option( 1 )
					.attachItem( ItemPool.VYKEA_DOWEL, -1, MANUAL );
				new Option( 2 )
					.attachItem( ItemPool.VYKEA_DOWEL, -11, MANUAL );
				new Option( 3 )
					.attachItem( ItemPool.VYKEA_DOWEL, -23, MANUAL );
				new Option( 4 )
					.attachItem( ItemPool.VYKEA_DOWEL, -37, MANUAL );
				new Option( 6 );
			}
		...
		new ChoiceAdventure( 1123, "Some Assembly Required", "Item-Driven" ) // Finishing Touch
		{
			void setup()
			{
				...
				new Option( 2 )
					.attachItem( ItemPool.VYKEA_RAIL, -5, MANUAL );
				new Option( 3 )
					.attachItem( ItemPool.VYKEA_BRACKET, -5, MANUAL );
			}
		...
		new ChoiceAdventure( 1140, "Casing the Conservatory", "Gotpork Conservatory of Flowers" )
		{
			void setup()
			{
				...
				new Option( 3 );
				new Option( 4 )
					.attachItem( ItemPool.GLOB_OF_BAT_GLUE, -1, MANUAL, new NoDisplay() );
				new Option( 5 )
					.attachItem( ItemPool.FINGERPRINT_DUSTING_KIT, -3, MANUAL, new NoDisplay() );
			}
		};
		...
		new ChoiceAdventure( 1141, "Researching the Reservoir", "Gotpork Municipal Reservoir" )
		{
			void setup()
			{
				...
				new Option( 3 );
				new Option( 4 )
					.attachItem( ItemPool.BAT_AID_BANDAGE, -1, MANUAL, new NoDisplay() );
				new Option( 5 )
					.attachItem( ItemPool.ULTRACOAGULATOR, -3, MANUAL, new NoDisplay() );
			}
		};
		...
		new ChoiceAdventure( 1142, "Combing the Cemetery", "Gotpork Gardens Cemetery" )
		{
			void setup()
			{
				...
				new Option( 3 );
				new Option( 4 )
					.attachItem( ItemPool.BAT_BEARING, -1, MANUAL, new NoDisplay() );
				new Option( 5 )
					.attachItem( ItemPool.EXPLODING_KICKBALL, -3, MANUAL, new NoDisplay() );
			}
		};
		...
		new ChoiceAdventure( 1143, "Searching the Sewers", "Gotpork City Sewers" )
		{
			void setup()
			{
				...
				new Option( 3 );
				new Option( 4 )
					.attachItem( ItemPool.BAT_OOMERANG, -1, MANUAL, new NoDisplay() );
			}
		};
		...
		new ChoiceAdventure( 1144, "Assessing the Asylum", "Porkham Asylum" )
		{
			void setup()
			{
				...
				new Option( 3 );
				new Option( 4 )
					.attachItem( ItemPool.BAT_O_MITE, -1, MANUAL, new NoDisplay() );
			}
		};
		...
		new ChoiceAdventure( 1145, "Looking Over the Library", "The Old Gotpork Library" )
		{
			void setup()
			{
				...
				new Option( 3 );
				new Option( 4 )
					.attachItem( ItemPool.BAT_JUTE, -1, MANUAL, new NoDisplay() );
			}
		};
		...
		new ChoiceAdventure( 1146, "Considering the Clock Factory", "Gotpork Clock, Inc." )
		{
			void setup()
			{
				...
				new Option( 3 );
				new Option( 4 )
					.attachItem( ItemPool.EXPLODING_KICKBALL, -1, MANUAL, new NoDisplay() );
			}
		};
		...
		new ChoiceAdventure( 1147, "Frisking the Foundry", "Gotpork Foundry" )
		{
			void setup()
			{
				...
				new Option( 3 );
				new Option( 4 )
					.attachItem( ItemPool.ULTRACOAGULATOR, -1, MANUAL, new NoDisplay() );
			}
		};
		...
		new ChoiceAdventure( 1148, "Taking Stock of the Trivia Company", "Trivial Pursuits, LLC" )
		{
			void setup()
			{
				...
				new Option( 3 );
				new Option( 4 )
					.attachItem( ItemPool.FINGERPRINT_DUSTING_KIT, -1, MANUAL, new NoDisplay() );
			}
		};
		...
		new ChoiceAdventure( 1151, "Half-man, Half-squid, Half-burr-- Wait.", "Gotpork Municipal Reservoir" )
		{
			void setup()
			{
				new Option( 1 );
		...
		new ChoiceAdventure( 1174, "The Investigation Continues", "Investigating a Plaintive Telegram" ) // bis
		{
			void setup()
			{
				new Option( 1 );
		...
		new ChoiceAdventure( 1175, "The Investigation Thrillingly Concludes!", "Investigating a Plaintive Telegram" )
		{
			void setup()
			{
				new Option( 1 );
		...
		new ChoiceAdventure( 1182, "Play against the Witchess Pieces", "Item-Driven" )
		{
			...
			boolean registerRequest( String urlString, int decision )
			{
				...
				if ( decision == 1 )
				{
					...
					RequestLogger.updateSessionLog( "Took choice " + this.choice + "/" + decision + ": " + desc );
				}
				return true;
			}
		...
		{
			final Pattern ORACLE_QUEST_PATTERN = Pattern.compile( "don't remember leaving any spoons in (.*?)&quot;" );
			...
			void setup()
			{
				...
				new Option( 1 );
				new Option( 2 )
					.attachItem( ItemPool.NO_SPOON, -1, MANUAL, new NoDisplay() );
				new Option( 3 );
				new Option( 4 );
			}
		...
		new ChoiceAdventure( 1191, "Source Terminal", "Item-Driven" )
		{
			...
			final Pattern ENHANCE_EFFECT_PATTERN = Pattern.compile( "acquire an effect: (.*?) \\(duration: (\\d+) Adventures\\)</div>" );
			...
			final Pattern CHIPS_PATTERN = Pattern.compile( "PRAM chips installed: (\\d+).*?GRAM chips installed: (\\d+).*?SPAM chips installed: (\\d+)" );
			...
			void postChoice1( GenericRequest request, int decision )
			{
				...
				else if ( input.startsWith( "enquiry" ) )
				{
					...
					Preferences.setString( "sourceTerminalEnquiry", request.responseText.substring( beginIndex, endIndex ) );
				}
		...
		{
			final Pattern TIME_SPINNER_MEDALS_PATTERN = Pattern.compile( "memory of earning <b>(\\d+) medal" );
