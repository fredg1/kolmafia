...
public class SeaMerkinOutpostManager
{
	...
	{
		new Tent( 313, MERKIN_BURGLAR ),
		new Tent( 314, MERKIN_RAIDER ),
		new Tent( 315, MERKIN_HEALER ),
	};
	...
	public static final void visitOutpostTent( final int choiceNumber, final Map<Integer, Option> options, final AdventureResult[] defaultItemPerOption, final DisplayType[] displayTypePerOption, final DisplayType stashboxDisplayType )
	{
