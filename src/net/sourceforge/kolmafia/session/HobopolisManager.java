...
{
	private static final HashMap<String, AdventureResult> classInstruments = new HashMap<>();
	static
	{
		classInstruments.put( KoLCharacter.SEAL_CLUBBER, ItemPool.get( ItemPool.SEALSKIN_DRUM ) );
		classInstruments.put( KoLCharacter.TURTLE_TAMER, ItemPool.get( ItemPool.WASHBOARD_SHIELD ) );
		classInstruments.put( KoLCharacter.PASTAMANCER, ItemPool.get( ItemPool.SPAGHETTI_BOX_BANJO ) );
		classInstruments.put( KoLCharacter.SAUCEROR, ItemPool.get( ItemPool.MARINARA_JUG ) );
		classInstruments.put( KoLCharacter.DISCO_BANDIT, ItemPool.get( ItemPool.MAKESHIFT_CASTANETS ) );
		classInstruments.put( KoLCharacter.ACCORDION_THIEF, ItemPool.get( ItemPool.LEFT_HANDED_MELODICA ) );
	}

	private static final HashMap<String, String> performanceMessages = new HashMap<>();
	static
	{
		performanceMessages.put( KoLCharacter.SEAL_CLUBBER, "vigorously beating a sealskin drum" );
		performanceMessages.put( KoLCharacter.TURTLE_TAMER, "playing a washboard" );
		performanceMessages.put( KoLCharacter.PASTAMANCER, "plinking away at a spaghetti-box banjo" );
		performanceMessages.put( KoLCharacter.SAUCEROR, "huffing and puffing on a marinara jug" );
		performanceMessages.put( KoLCharacter.DISCO_BANDIT, "playing a pair of castanets" );
		performanceMessages.put( KoLCharacter.ACCORDION_THIEF, "toodling out a melody on a melodica" );
	}

	private static LinkedList<String> missingPerformers;
	...
	public static final AdventureResult getClassInstrument( final String KoLClass )
	{
	...
	public static final LinkedList<String> getMissingPerformers()
	{
	...
	public static final void parseTentSurvey( final String responseText )
	{
		...
		for ( Entry<String, String> entry : performanceMessages.entrySet() )
		{
