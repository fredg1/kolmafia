...
public abstract class LouvreManager {
  ...
  public static final String handleChoice(final int source, final int stepCount) {
    ...
    if (false && override.contains(",")) {
      // this handling was for the old Louvre. It doesn't work this way anymore
  ...
  public static final void choiceSpoilers(
      final int choice, final Function<Integer, Option> optionGenerator) {
    // We only handle LouvreManager choices
